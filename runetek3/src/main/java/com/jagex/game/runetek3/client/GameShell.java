...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
	...
	protected ImageProducerFrameBuffer drawArea;
	...
	protected final void initApplication() {
		...
		this.graphic = this.getBaseComponent().getGraphics();
	...
	@Override
	public void keyPressed(@OriginalArg(0) KeyEvent e) {
		this.idleCycles = 0;
	...
	@Override
	public void keyReleased(@OriginalArg(0) KeyEvent e) {
		this.idleCycles = 0;
	...
	@Override
	public void keyTyped(@OriginalArg(0) KeyEvent e) {
	}

	@OriginalMember(owner = "client!a", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V")
	@Override
	public void focusGained(@OriginalArg(0) FocusEvent e) {
		this.refresh = true;
		this.refresh();
		if (InputTracking.enabled) {
	...
	@Override
	public void focusLost(@OriginalArg(0) FocusEvent e) {
		if (InputTracking.enabled) {
	...
	protected void showProgress(@OriginalArg(1) String str, @OriginalArg(2) int progress) {
		...
		this.getBaseComponent().getFontMetrics(plain);
		if (this.refresh) {
