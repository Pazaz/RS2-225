...
public final class NpcEntity extends PathingEntity {
	...
	public final Model getDrawMethod() {
		if (this.info == null) {
			...
			@Pc(41) Model spotAnimModel = new Model(spotAnim.getModel(), true, !spotAnim.disposeAlpha, this.flowObfuscator1, false);
			...
			@Pc(123) Model animated = new Model(models, (byte) -31, 2, true);
			if (this.info.size == 1) {
