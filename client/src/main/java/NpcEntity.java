	...
	public Model getDrawMethod(@OriginalArg(0) boolean arg0) {
		try {
			if (this.aClass3_1 == null) {
				...
				local41.translate(-super.anInt916, 0, -122, 0);
				local41.applyGroup(4);
				local41.applyFrame(-16599, local25.aClass19_1.anIntArray186[super.anInt913]);
	...
	private Model getModel(@OriginalArg(0) boolean arg0) {
		try {
			...
			if (super.anInt907 >= 0 && super.anInt910 == 0) {
				...
				return this.aClass3_1.getModel(local14, local16, SeqType.aClass19Array1[super.anInt907].anIntArray189);
			}
			local14 = -1;
			if (arg0) {
				throw new NullPointerException();
			...
			@Pc(71) Model local71 = this.aClass3_1.getModel(local14, -1, null);
