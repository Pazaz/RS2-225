...
public final class Class1_Sub3_Sub2_Sub4 extends Class1_Sub3_Sub2 {
	...
	public final void method362(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2, @OriginalArg(4) int arg3) {
	...
	public final void method363(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3, @OriginalArg(4) String arg4) {
	...
	public final int method364(@OriginalArg(1) String arg0) {
		if (arg0 == null) {
			return 0;
		}
		@Pc(7) int local7 = 0;
	...
	public final void method365(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) String arg3) {
		if (arg3 == null) {
			return;
		}
	...
	public final void method366(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) String arg4) {
		if (arg4 == null) {
			return;
		}
	...
	public final void method367(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4) {
		if (arg2 == null) {
			return;
		}
	...
	public final void method368(@OriginalArg(0) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) String arg2, @OriginalArg(6) int arg3) {
		if (arg2 == null) {
			return;
		}
		...
		for (@Pc(30) int local30 = 0; local30 < arg2.length(); local30++) {
			if (arg2.charAt(local30) == '@' && local30 + 4 < arg2.length() && arg2.charAt(local30 + 4) == '@') {
				arg1 = this.method369(arg2.substring(local30 + 1, local30 + 4));
				local30 += 4;
			} else {
				@Pc(71) int local71 = anIntArray185[arg2.charAt(local30)];
				if (local71 != 94) {
					this.method372(this.aByteArrayArray3[local71], arg3 + this.anIntArray181[local71] + 1, this.anIntArray180[local71], 0, local22 + this.anIntArray182[local71] + 1, 192, this.anIntArray179[local71]);
					this.method372(this.aByteArrayArray3[local71], arg3 + this.anIntArray181[local71], this.anIntArray180[local71], arg1, local22 + this.anIntArray182[local71], local17, this.anIntArray179[local71]);
				}
	...
	private void method372(@OriginalArg(0) byte[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		@Pc(10) int local10 = arg1 + arg4 * Static12.anInt528;
		@Pc(14) int local14 = Static12.anInt528 - arg6;
		@Pc(16) int local16 = 0;
		@Pc(18) int local18 = 0;
		@Pc(25) int local25;
		if (arg4 < Static12.anInt530) {
			local25 = Static12.anInt530 - arg4;
			arg2 -= local25;
			arg4 = Static12.anInt530;
			local18 = local25 * arg6 + 0;
			local10 += local25 * Static12.anInt528;
		}
		if (arg4 + arg2 >= Static12.anInt531) {
			arg2 -= arg4 + arg2 + 1 - Static12.anInt531;
		}
		if (arg1 < Static12.anInt532) {
			local25 = Static12.anInt532 - arg1;
			arg6 -= local25;
			arg1 = Static12.anInt532;
			local18 += local25;
			local10 += local25;
		...
		if (arg1 + arg6 >= Static12.anInt533) {
			local25 = arg1 + arg6 + 1 - Static12.anInt533;
			arg6 -= local25;
			local16 += local25;
			local14 += local25;
		}
		if (arg6 > 0 && arg2 > 0) {
			this.method373(arg2, local10, arg6, Static12.anIntArray178, arg0, arg5, local18, local14, local16, arg3);
		}
	}

	@OriginalMember(owner = "client!jb", name = "a", descriptor = "(III[I[BIIIIBI)V")
	private void method373(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) byte[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(10) int arg9) {
