...
public final class Class44 {
	...
	public final int[] method576(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			...
			if (this.aClass42_3 != null) {
				...
				local201 += this.method577(local222, local40, this.aClass42_3.anInt821) >> 1;
				local40 += (local216 * local36 >> 16) + local38;
			}
			if (this.aClass42_5 != null) {
				local216 = this.aClass42_5.method554(arg0);
				local222 = this.aClass42_6.method554(arg0);
				local207 = local207 * ((this.method577(local222, local81, this.aClass42_5.anInt821) >> 1) + 32768) >> 15;
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray236[local216] != 0) {
					...
					if (local222 < arg0) {
						Static34.anIntArray239[local222] += this.method577(local207 * Static34.anIntArray244[local216] >> 15, Static34.anIntArray242[local216], this.aClass42_1.anInt821);
	...
	private int method577(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		if (this.anInt944 != -15143) {
			...
			return Static34.anIntArray241[arg1 & 0x7FFF] * arg0 >> 14;
		} else if (arg2 == 3) {
			return ((arg1 & 0x7FFF) * arg0 >> 14) - arg0;
		} else if (arg2 == 4) {
			return Static34.anIntArray240[arg1 / 2607 & 0x7FFF] * arg0;
		} else {
			return 0;
		}
	}
	...
	public final void method578(@OriginalArg(1) Class1_Sub3_Sub3 arg0) {
