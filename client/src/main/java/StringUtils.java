...
public final class StringUtils {
	...
	public static long genHash(@OriginalArg(1) String arg1) {
	...
	public static String fromIPv4(@OriginalArg(1) int arg1) {
	...
	public static String censor(@OriginalArg(1) String arg1) {
		@Pc(1) String local1 = "";
