...
public final class IndexedSprite extends Draw2D {
	...
	public IndexedSprite(@OriginalArg(0) FileArchive arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		@Pc(32) Buffer dat = new Buffer(363, arg0.read(arg1 + ".dat", null));
		@Pc(42) Buffer idx = new Buffer(363, arg0.read("index.dat", null));
		idx.offset = dat.g2();
	...
	public final void shrink(@OriginalArg(0) boolean obfuscator) {
		this.clipWidth /= 2;
		this.clipHeight /= 2;
