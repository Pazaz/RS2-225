...
public final class Class1_Sub3_Sub2_Sub2 extends Class1_Sub3_Sub2 {
	...
	public final void method318() {
		Static12.method354(this.anInt461, this.anIntArray148, this.anInt462);
	}
	...
	public final void method320(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		arg0 += this.anInt463;
		arg1 += this.anInt464;
		@Pc(15) int local15 = arg0 + arg1 * Static12.anInt528;
		@Pc(17) int local17 = 0;
		...
		if (arg1 < Static12.anInt530) {
			local36 = Static12.anInt530 - arg1;
			local20 -= local36;
			arg1 = Static12.anInt530;
			local17 = local36 * local23 + 0;
			local15 += local36 * Static12.anInt528;
		}
		if (arg1 + local20 > Static12.anInt531) {
			local20 -= arg1 + local20 - Static12.anInt531;
		}
		if (arg0 < Static12.anInt532) {
			local36 = Static12.anInt532 - arg0;
			local23 -= local36;
			arg0 = Static12.anInt532;
			local17 += local36;
			local15 += local36;
			local29 = local36 + 0;
			local27 += local36;
		}
		if (arg0 + local23 > Static12.anInt533) {
			local36 = arg0 + local23 - Static12.anInt533;
			local23 -= local36;
			local29 += local36;
			local27 += local36;
		}
		if (local23 > 0 && local20 > 0) {
			this.method321(this.anIntArray148, local27, local20, local17, local29, local15, local23, Static12.anIntArray178);
		}
	}
	...
	public final void method322(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local28 > 0 && local25 > 0) {
			this.method323(Static12.anIntArray178, this.anIntArray148, local22, local20, local28, local25, local32, local34);
		}
	}
	...
	public final void method324() {
		try {
			...
			@Pc(137) int local137 = local56 + local69 * Static12.anInt528;
			@Pc(141) int local141 = Static12.anInt528 - local120;
			@Pc(148) int local148;
			if (local69 < Static12.anInt530) {
				local148 = Static12.anInt530 - local69;
				local131 -= local148;
				local69 = 0;
				local137 += local148 * Static12.anInt528;
				local13 += local43 * local148;
			}
			if (local69 + local131 > Static12.anInt531) {
				local131 -= local69 + local131 - Static12.anInt531;
			}
			if (local56 < Static12.anInt532) {
				local148 = Static12.anInt532 - local56;
				local120 -= local148;
				local56 = 0;
				local137 += local148;
			...
			if (local56 + local120 > Static12.anInt533) {
				local148 = local56 + local120 - Static12.anInt533;
				local120 -= local148;
				local141 += local148;
			}
			this.method325(local11, local37, Static12.anIntArray178, local43, local13, this.anIntArray148, local141, local137, local131, local6, local120);
	...
	public final void method326(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		arg0 += this.anInt463;
		arg1 += this.anInt464;
		@Pc(25) int local25 = arg0 + arg1 * Static12.anInt528;
		@Pc(27) int local27 = 0;
		...
		@Pc(46) int local46;
		if (arg1 < Static12.anInt530) {
			local46 = Static12.anInt530 - arg1;
			local30 -= local46;
			arg1 = Static12.anInt530;
			local27 = local46 * local33 + 0;
			local25 += local46 * Static12.anInt528;
		}
		if (arg1 + local30 > Static12.anInt531) {
			local30 -= arg1 + local30 - Static12.anInt531;
		}
		if (arg0 < Static12.anInt532) {
			local46 = Static12.anInt532 - arg0;
			local33 -= local46;
			arg0 = Static12.anInt532;
			local27 += local46;
			local25 += local46;
		...
		if (arg0 + local33 > Static12.anInt533) {
			local46 = arg0 + local33 - Static12.anInt533;
			local33 -= local46;
			local39 += local46;
			local37 += local46;
		}
		if (local33 > 0 && local30 > 0) {
			this.method327(local25, this.anIntArray148, local30, Static12.anIntArray178, local27, local33, local37, local39);
		}
	}
	...
	public final void method329(@OriginalArg(0) Class1_Sub3_Sub2_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		arg2 += this.anInt463;
		arg1 += this.anInt464;
		...
		if (local27 > 0 && local24 > 0) {
			this.method330(local27, local33, local24, local17, Static12.anIntArray178, this.anIntArray148, local15, arg0.aByteArray6, local31);
		}
	}
