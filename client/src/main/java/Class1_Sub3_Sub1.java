...
public final class Class1_Sub3_Sub1 extends Class1_Sub3 {
	...
	public final void method231(@OriginalArg(1) int arg0) {
		...
		@Pc(11) Class12 local11 = Static14.aClass12Array1[arg0];
	...
	public final void method232(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int[] arg2) {
		...
		@Pc(19) Class12 local19 = Static14.aClass12Array1[arg1];
	...
	public final void method235(@OriginalArg(1) int arg0) {
		@Pc(3) int local3 = Static10.anIntArray124[arg0];
		@Pc(7) int local7 = Static10.anIntArray125[arg0];
	...
	public final void method243(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		@Pc(7) int local7 = Static10.anIntArray124[0];
		@Pc(11) int local11 = Static10.anIntArray125[0];
		@Pc(15) int local15 = Static10.anIntArray124[arg0];
		@Pc(19) int local19 = Static10.anIntArray125[arg0];
		@Pc(23) int local23 = Static10.anIntArray124[arg1];
		@Pc(27) int local27 = Static10.anIntArray125[arg1];
		@Pc(31) int local31 = Static10.anIntArray124[arg2];
		@Pc(35) int local35 = Static10.anIntArray125[arg2];
	...
	private void method247(@OriginalArg(0) int arg0) {
		...
		@Pc(85) int local85;
		if (local26 >= 50) {
			Static10.anIntArray120[0] = Static10.anIntArray109[local12];
			Static10.anIntArray121[0] = Static10.anIntArray110[local12];
			local7++;
			Static10.anIntArray122[0] = this.anIntArray97[arg0];
		} else {
			...
			if (local34 >= 50) {
				...
				Static10.anIntArray120[0] = local3 + (local63 + ((Static10.anIntArray112[local22] - local63) * local85 >> 16) << 9) / 50;
				Static10.anIntArray121[0] = local5 + (local67 + ((Static10.anIntArray113[local22] - local67) * local85 >> 16) << 9) / 50;
				local7++;
				Static10.anIntArray122[0] = local72 + ((this.anIntArray99[arg0] - local72) * local85 >> 16);
			}
			if (local30 >= 50) {
