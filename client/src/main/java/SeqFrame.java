...
public final class SeqFrame {
	...
	public static void method276(@OriginalArg(1) FileArchive arg0) {
		@Pc(17) Buffer local17 = new Buffer(363, arg0.method536("frame_head.dat", null));
		@Pc(27) Buffer local27 = new Buffer(363, arg0.method536("frame_tran1.dat", null));
		@Pc(37) Buffer local37 = new Buffer(363, arg0.method536("frame_tran2.dat", null));
		@Pc(47) Buffer local47 = new Buffer(363, arg0.method536("frame_del.dat", null));
