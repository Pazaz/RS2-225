...
public final class IdkType {
	...
	public static void method304(@OriginalArg(0) FileArchive arg0) {
		@Pc(9) Buffer local9 = new Buffer(363, arg0.method536("idk.dat", null));
		...
		for (@Pc(19) int local19 = 0; local19 < anInt437; local19++) {
			...
			aIdkTypeArray1[local19].method305(local9);
		}
	}
	...
	private void method305(@OriginalArg(1) Buffer arg0) {
		while (true) {
