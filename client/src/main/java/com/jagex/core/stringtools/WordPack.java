...
public class WordPack {
	...
	private static void readBad(@OriginalArg(1) Buffer arg1) {
		@Pc(2) int local2 = arg1.g4();
		bads = new char[local2][];
		badCombinations = new byte[local2][][];
		readBad(badCombinations, bads, arg1);
	}
	...
	private static boolean isValid(@OriginalArg(1) char arg1) {
	...
	private static void replaceUppercases(@OriginalArg(0) char[] arg0, @OriginalArg(2) char[] arg2) {
		for (@Pc(1) int local1 = 0; local1 < arg2.length; local1++) {
			if (arg0[local1] != '*' && isUppercaseAlpha(arg2[local1])) {
	...
	private static void filterBad(@OriginalArg(1) char[] arg1) {
		for (@Pc(3) int local3 = 0; local3 < 2; local3++) {
			for (@Pc(10) int local10 = bads.length - 1; local10 >= 0; local10--) {
				filterBad(badCombinations[local10], arg1, bads[local10]);
			}
		}
	}
			...
			for (@Pc(15) int local15 = 0; local15 <= arg4.length - arg3.length; local15 += local23) {
				...
				label62: while (true) {
					while (true) {
						...
						@Pc(58) int local58;
						if (local21 < arg3.length && (local58 = getEmulatedDomainCharLen(local33, arg3[local21], local31)) > 0) {
							local19 += local58;
							local21++;
						} else {
							if (local21 == 0) {
							...
							@Pc(79) int local79;
							if ((local79 = getEmulatedDomainCharLen(local33, arg3[local21 - 1], local31)) > 0) {
								local19 += local79;
								if (local21 == 1) {
									local23++;
								}
			...
			for (@Pc(20) int local20 = 0; local20 <= arg3.length - arg4.length; local20 += local5) {
				...
				label124: while (true) {
					while (true) {
						...
						@Pc(63) int local63;
						if (local26 < arg4.length && (local63 = getEmulatedDomainCharLen(local38, arg4[local26], local36)) > 0) {
							local24 += local63;
							local26++;
						} else {
							if (local26 == 0) {
							...
							@Pc(84) int local84;
							if ((local84 = getEmulatedDomainCharLen(local38, arg4[local26 - 1], local36)) > 0) {
								local24 += local84;
								if (local26 == 1) {
									local5++;
								}
	...
	private static void filterBad(@OriginalArg(1) byte[][] arg1, @OriginalArg(2) char[] arg2, @OriginalArg(3) char[] arg3) {
			...
			for (@Pc(16) int local16 = 0; local16 <= arg2.length - arg3.length; local16 += local26) {
				...
				label163: while (true) {
					while (true) {
						...
						@Pc(67) int local67;
						if (local22 < arg3.length && (local67 = getEmulatedBadCharLen(var14, arg3[local22], var13)) > 0) {
							if (local67 == 1 && isNumeral(var13)) {
								local30 = true;
							}
							if (local67 == 2 && (isNumeral(var13) || isNumeral(var14))) {
								local30 = true;
							}
							local20 += local67;
							local22++;
							...
							@Pc(110) int local110;
							if ((local110 = getEmulatedBadCharLen(var14, arg3[local22 - 1], var13)) > 0) {
								local20 += local110;
								if (local22 == 1) {
									local26++;
								}
							} else {
								if (local22 >= arg3.length || !isNotLowercaseAlpha(var13)) {
									break label163;
								}
	...
	private static int getEmulatedDomainCharLen(@OriginalArg(1) char arg1, @OriginalArg(2) char arg2, @OriginalArg(3) char arg3) {
		if (arg2 == arg3) {
			return 1;
	...
	private static void filterNumFragments(@OriginalArg(1) char[] arg1) {
		...
		while (true) {
			do {
				...
				for (@Pc(19) int local19 = local5; local19 >= 0 && local19 < local112 && !local17; local19++) {
					if (!isSymbol(arg1[local19]) && !isNotLowercaseAlpha(arg1[local19])) {
						local17 = true;
					}
				}
				if (local17) {
	...
	private static boolean isLowercaseAlpha(@OriginalArg(1) char arg1) {
		return arg1 >= 'a' && arg1 <= 'z';
	}

	@OriginalMember(owner = "client!mc", name = "d", descriptor = "(IC)Z")
	private static boolean isUppercaseAlpha(@OriginalArg(1) char arg1) {
		return arg1 >= 'A' && arg1 <= 'Z';
	}
	...
	private static int getInteger(@OriginalArg(1) char[] arg1) {
		if (arg1.length > 6) {
			return 0;
		}
		@Pc(9) int local9 = 0;
