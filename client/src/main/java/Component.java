				...
				do {
						...
						for (local155 = 0; local155 < 20; local155++) {
							...
							if (local160 == 1) {
								...
								if (arg0 != null && local352.length() > 0) {
									...
									local62.inventorySprite[local155] = getSprite(arg0, Integer.parseInt(local352.substring(local361 + 1)), local352.substring(0, local361), -36068);
								}
							}
						}
					...
					if (local62.type == 5) {
						...
						if (arg0 != null && local511.length() > 0) {
							...
							local62.graphic = getSprite(arg0, Integer.parseInt(local511.substring(local160 + 1)), local511.substring(0, local160), -36068);
						}
						local511 = local27.gstr();
						if (arg0 != null && local511.length() > 0) {
							local160 = local511.lastIndexOf(",");
							local62.activegraphic = getSprite(arg0, Integer.parseInt(local511.substring(local160 + 1)), local511.substring(0, local160), -36068);
						}
					}
					if (local62.type == 6) {
						local45 = local27.g1();
		...
		try {
			...
			if (arg3 != -36068) {
				...
				try {
					...
					spriteCache.put(6, local8, local13);
					return local13;
