...
public final class SeqBase {
	...
	public static void method261(@OriginalArg(1) FileArchive arg0) {
		@Pc(11) Buffer local11 = new Buffer(363, arg0.method536("base_head.dat", null));
		@Pc(21) Buffer local21 = new Buffer(363, arg0.method536("base_type.dat", null));
		@Pc(31) Buffer local31 = new Buffer(363, arg0.method536("base_label.dat", null));
