...
public final class Model extends CacheableNode {
	...
	public static void decode(@OriginalArg(0) int obfuscator, @OriginalArg(1) FileArchive archive) {
		if (obfuscator < 3 || obfuscator > 3) {
			return;
		}
		try {
			head = new Buffer(363, archive.read("ob_head.dat", null));
			face1 = new Buffer(363, archive.read("ob_face1.dat", null));
			face2 = new Buffer(363, archive.read("ob_face2.dat", null));
			face3 = new Buffer(363, archive.read("ob_face3.dat", null));
			face4 = new Buffer(363, archive.read("ob_face4.dat", null));
			face5 = new Buffer(363, archive.read("ob_face5.dat", null));
			point1 = new Buffer(363, archive.read("ob_point1.dat", null));
			point2 = new Buffer(363, archive.read("ob_point2.dat", null));
			point3 = new Buffer(363, archive.read("ob_point3.dat", null));
			point4 = new Buffer(363, archive.read("ob_point4.dat", null));
			point5 = new Buffer(363, archive.read("ob_point5.dat", null));
			vertex1 = new Buffer(363, archive.read("ob_vertex1.dat", null));
			vertex2 = new Buffer(363, archive.read("ob_vertex2.dat", null));
			axis = new Buffer(363, archive.read("ob_axis.dat", null));
			head.offset = 0;
			point1.offset = 0;
			point2.offset = 0;
			point3.offset = 0;
			...
			metadata = new ModelMetadata[count + 100];
			...
			for (@Pc(193) int n = 0; n < count; n++) {
				...
				@Pc(206) ModelMetadata meta = metadata[index] = new ModelMetadata();
				meta.vertexCount = head.g2();
				meta.triangleCount = head.g2();
				meta.texturedCount = head.g1();
				meta.vertexFlagDataOffset = point1.offset;
				meta.vertexXDataOffset = point2.offset;
				meta.vertexYDataOffset = point3.offset;
				meta.vertexZDataOffset = point4.offset;
				meta.vertexIndexDataOffset = vertex1.offset;
				meta.triangleTypeDataOffset = vertex2.offset;
	...
	public Model(@OriginalArg(0) boolean obfuscator, @OriginalArg(1) int id) {
		if (metadata != null) {
			@Pc(28) ModelMetadata meta = metadata[id];
			if (meta == null) {
				...
				point1.offset = meta.vertexFlagDataOffset;
				point2.offset = meta.vertexXDataOffset;
				point3.offset = meta.vertexYDataOffset;
				point4.offset = meta.vertexZDataOffset;
				point5.offset = meta.vertexLabelDataOffset;
				...
				for (@Pc(181) int local181 = 0; local181 < this.vertexCount; local181++) {
					...
					local188 = 0;
					if ((local186 & 0x1) != 0) {
						local188 = point2.gSmart1or2s();
					}
					local197 = 0;
					if ((local186 & 0x2) != 0) {
						local197 = point3.gSmart1or2s();
					}
					local206 = 0;
					if ((local186 & 0x4) != 0) {
						local206 = point4.gSmart1or2s();
					}
				...
				face1.offset = meta.triangleColorDataOffset;
				face2.offset = meta.triangleInfoDataOffset;
				face3.offset = meta.trianglePriorityDataOffset;
				face4.offset = meta.triangleAlphaDataOffset;
				face5.offset = meta.triangleSkinDataOffset;
				...
				vertex1.offset = meta.vertexIndexDataOffset;
				vertex2.offset = meta.triangleTypeDataOffset;
				local188 = 0;
				local197 = 0;
				local206 = 0;
				...
				for (@Pc(352) int local352 = 0; local352 < this.triangleCount; local352++) {
					local357 = vertex2.g1();
					if (local357 == 1) {
						local188 = vertex1.gSmart1or2s() + local350;
						local197 = vertex1.gSmart1or2s() + local188;
						local206 = vertex1.gSmart1or2s() + local197;
						local350 = local206;
					...
					if (local357 == 2) {
						local188 = local188;
						local197 = local206;
						local206 = vertex1.gSmart1or2s() + local350;
						local350 = local206;
						this.triangleVertexA[local352] = local188;
						this.triangleVertexB[local352] = local197;
						this.triangleVertexC[local352] = local206;
				...
				axis.offset = meta.triangleTextureDataOffset * 6;
	...
	public Model(@OriginalArg(0) int obfuscator, @OriginalArg(1) Model[] arg1, @OriginalArg(2) int arg2) {
	...
	public Model(@OriginalArg(0) Model[] arg0, @OriginalArg(1) byte obfuscator1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean obfuscator2) {
		@Pc(23) boolean local23 = false;
		@Pc(25) boolean local25 = false;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
	...
	public Model(@OriginalArg(0) Model arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int obfuscator, @OriginalArg(4) boolean arg4) {
	...
	public Model(@OriginalArg(0) Model arg0, @OriginalArg(1) byte obfuscator, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3) {
		this.vertexCount = arg0.vertexCount;
		this.triangleCount = arg0.triangleCount;
		this.texturedCount = arg0.texturedCount;
		@Pc(42) int local42;
	...
	public Model(@OriginalArg(0) int obfuscator, @OriginalArg(1) Model arg1, @OriginalArg(2) boolean arg2) {
	...
	public final void calculateYBoundaries2(@OriginalArg(0) int obfuscator) {
		this.maxBoundY = 0;
		@Pc(8) int local8;
		if (obfuscator != 0) {
	...
	private void calculateBoundaries(@OriginalArg(0) byte obfuscator) {
		this.maxBoundY = 0;
		if (obfuscator != this.flowObfuscator3) {
			return;
		}
		this.lengthXZ = 0;
		this.minBoundY = 0;
	...
	public final void applyLighting(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (arg5) {
			...
			this.calculateBoundaries(this.flowObfuscator4);
		}
	}
	...
	public final void draw(@OriginalArg(1) int yaw, @OriginalArg(2) int roll, @OriginalArg(3) int cameraPitch, @OriginalArg(4) int cameraX, @OriginalArg(5) int cameraY, @OriginalArg(6) int cameraZ) {
	...
	public final void draw(@OriginalArg(0) int yaw, @OriginalArg(1) int sinCameraPitch, @OriginalArg(2) int cosCameraPitch, @OriginalArg(3) int sinCameraYaw, @OriginalArg(4) int cosCameraYaw, @OriginalArg(5) int sceneX, @OriginalArg(6) int sceneY, @OriginalArg(7) int sceneZ, @OriginalArg(8) int key) {
	...
	private void drawProjectedTriangle(@OriginalArg(0) int index) {
		...
		if (zA >= 50) {
			...
			if (zC >= 50) {
				yA = (50 - zA) * oneOverFixed1616[zC - zA];
				tmpX[0] = centerX + (xA + ((projectSceneX[c] - xA) * yA >> 16) << 9) / 50;
				tmpY[0] = centerY + (xB + ((projectSceneY[c] - xB) * yA >> 16) << 9) / 50;
				n++;
				tmpZ[0] = xC + ((this.colorC[index] - xC) * yA >> 16);
			}
			if (zB >= 50) {
				yA = (50 - zA) * oneOverFixed1616[zB - zA];
				tmpX[n] = centerX + (xA + ((projectSceneX[b] - xA) * yA >> 16) << 9) / 50;
				tmpY[n] = centerY + (xB + ((projectSceneY[b] - xB) * yA >> 16) << 9) / 50;
		...
		if (zB >= 50) {
			...
			if (zA >= 50) {
				yA = (50 - zB) * oneOverFixed1616[zA - zB];
				tmpX[n] = centerX + (xA + ((projectSceneX[a] - xA) * yA >> 16) << 9) / 50;
				tmpY[n] = centerY + (xB + ((projectSceneY[a] - xB) * yA >> 16) << 9) / 50;
				tmpZ[n++] = xC + ((this.colorA[index] - xC) * yA >> 16);
			}
			if (zC >= 50) {
				yA = (50 - zB) * oneOverFixed1616[zC - zB];
				tmpX[n] = centerX + (xA + ((projectSceneX[c] - xA) * yA >> 16) << 9) / 50;
				tmpY[n] = centerY + (xB + ((projectSceneY[c] - xB) * yA >> 16) << 9) / 50;
		...
		if (zC >= 50) {
			...
			if (zB >= 50) {
				yA = (50 - zC) * oneOverFixed1616[zB - zC];
				tmpX[n] = centerX + (xA + ((projectSceneX[b] - xA) * yA >> 16) << 9) / 50;
				tmpY[n] = centerY + (xB + ((projectSceneY[b] - xB) * yA >> 16) << 9) / 50;
				tmpZ[n++] = xC + ((this.colorB[index] - xC) * yA >> 16);
			}
			if (zA >= 50) {
				yA = (50 - zC) * oneOverFixed1616[zA - zC];
				tmpX[n] = centerX + (xA + ((projectSceneX[a] - xA) * yA >> 16) << 9) / 50;
				tmpY[n] = centerY + (xB + ((projectSceneY[a] - xB) * yA >> 16) << 9) / 50;
				tmpZ[n++] = xC + ((this.colorA[index] - xC) * yA >> 16);
			}
