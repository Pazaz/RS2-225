...
public final class SceneGraph {
	...
	public static void method50(@OriginalArg(0) int arg0, @OriginalArg(1) LinkedList arg1, @OriginalArg(2) CollisionMap arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[][][] arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) MapSquare arg9, @OriginalArg(11) int arg10) {
		...
		@Pc(60) LocType local60 = LocType.method23(arg7);
		...
		if (arg8 == 22) {
			...
			arg9.method473(local99, arg0, local72, arg3, arg6, local86, local57);
			if (local60.aBoolean7 && local60.aBoolean9) {
				arg2.method252(arg3, arg0);
			}
			if (local60.anInt45 != -1) {
				arg1.method453(new LocEntity(true, arg7, arg6, 0, 3, SeqType.aSeqTypeArray1[local60.anInt45], arg3, arg0));
			}
			return;
		}
		@Pc(174) int local174;
		if (arg8 == 10 || arg8 == 11) {
			...
			if (local99 != null) {
				...
				arg9.method477(local57, arg6, null, local72, arg3, arg0, local174, local86, local99, local161, local177);
			}
			if (local60.aBoolean7) {
				arg2.method251(arg4, local60.anInt44, local60.anInt43, arg0, arg3, local60.aBoolean8);
			}
			if (local60.anInt45 != -1) {
				arg1.method453(new LocEntity(true, arg7, arg6, 0, 2, SeqType.aSeqTypeArray1[local60.anInt45], arg3, arg0));
			}
		} else if (arg8 >= 12) {
			local99 = local60.method26(arg8, arg4, local15, local25, local37, local47, -1);
			arg9.method477(local57, arg6, null, local72, arg3, arg0, 1, local86, local99, 0, 1);
			if (local60.aBoolean7) {
				arg2.method251(arg4, local60.anInt44, local60.anInt43, arg0, arg3, local60.aBoolean8);
			}
			if (local60.anInt45 != -1) {
			...
			if (local60.anInt45 != -1) {
				arg1.method453(new LocEntity(true, arg7, arg6, 0, 0, SeqType.aSeqTypeArray1[local60.anInt45], arg3, arg0));
			}
		} else if (arg8 == 1) {
			...
			if (arg8 == 2) {
				...
				arg9.method476(local57, arg3, 0, local72, arg4 * 512, anIntArray18[arg4], 0, arg0, local99, local86, arg6);
				if (local60.anInt45 != -1) {
					arg1.method453(new LocEntity(true, arg7, arg6, 0, 1, SeqType.aSeqTypeArray1[local60.anInt45], arg3, arg0));
				}
			} else if (arg8 == 5) {
				local430 = 16;
				...
				arg9.method476(local57, arg3, anIntArray21[arg4] * local430, local72, arg4 * 512, anIntArray18[arg4], anIntArray20[arg4] * local430, arg0, local452, local86, arg6);
				if (local60.anInt45 != -1) {
					arg1.method453(new LocEntity(true, arg7, arg6, 0, 1, SeqType.aSeqTypeArray1[local60.anInt45], arg3, arg0));
				}
			} else if (arg8 == 6) {
				local99 = local60.method26(4, 0, local15, local25, local37, local47, -1);
				arg9.method476(local57, arg3, 0, local72, arg4, 256, 0, arg0, local99, local86, arg6);
				if (local60.anInt45 != -1) {
					arg1.method453(new LocEntity(true, arg7, arg6, 0, 1, SeqType.aSeqTypeArray1[local60.anInt45], arg3, arg0));
				}
			} else if (arg8 == 7) {
				local99 = local60.method26(4, 0, local15, local25, local37, local47, -1);
				arg9.method476(local57, arg3, 0, local72, arg4, 512, 0, arg0, local99, local86, arg6);
				if (local60.anInt45 != -1) {
					arg1.method453(new LocEntity(true, arg7, arg6, 0, 1, SeqType.aSeqTypeArray1[local60.anInt45], arg3, arg0));
				}
			} else if (arg8 == 8) {
				local99 = local60.method26(4, 0, local15, local25, local37, local47, -1);
				arg9.method476(local57, arg3, 0, local72, arg4, 768, 0, arg0, local99, local86, arg6);
				if (local60.anInt45 != -1) {
					arg1.method453(new LocEntity(true, arg7, arg6, 0, 1, SeqType.aSeqTypeArray1[local60.anInt45], arg3, arg0));
				}
			}
	...
	public final void method36(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) byte local3 = 0;
	...
	public final void method37(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
	...
	public final void method38(@OriginalArg(0) byte[] arg0, @OriginalArg(1) MapSquare arg1, @OriginalArg(2) CollisionMap[] arg2, @OriginalArg(3) LinkedList arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(7) Buffer local7 = new Buffer(363, arg0);
		@Pc(19) int local19 = -1;
		while (true) {
	...
	private void method39(@OriginalArg(0) CollisionMap arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) MapSquare arg5, @OriginalArg(7) LinkedList arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		if (aBoolean23) {
		...
		@Pc(84) LocType local84 = LocType.method23(arg7);
		...
		if (arg4 != 22) {
			...
			if (arg4 == 10 || arg4 == 11) {
				...
				if (local132 != null) {
					...
					if (arg5.method477(local81, arg1, null, local96, arg2, arg8, local209, local110, local132, local196, local212) && local84.aBoolean15) {
				...
				if (local84.anInt45 != -1) {
					arg6.method453(new LocEntity(true, arg7, arg1, 0, 2, SeqType.aSeqTypeArray1[local84.anInt45], arg2, arg8));
				}
			} else if (arg4 >= 12) {
				local132 = local84.method26(arg4, arg3, local36, local47, local60, local71, -1);
				arg5.method477(local81, arg1, null, local96, arg2, arg8, 1, local110, local132, 0, 1);
				...
				if (local84.anInt45 != -1) {
					arg6.method453(new LocEntity(true, arg7, arg1, 0, 0, SeqType.aSeqTypeArray1[local84.anInt45], arg2, arg8));
				}
				...
				if (arg4 == 2) {
					local810 = arg3 + 1 & 0x3;
					@Pc(822) Model local822 = local84.method26(2, arg3 + 4, local36, local47, local60, local71, -1);
					...
					arg5.method476(local81, arg2, 0, local96, arg3 * 512, anIntArray18[arg3], 0, arg8, local132, local110, arg1);
					if (local84.anInt45 != -1) {
						arg6.method453(new LocEntity(true, arg7, arg1, 0, 1, SeqType.aSeqTypeArray1[local84.anInt45], arg2, arg8));
					}
				} else if (arg4 == 5) {
					local810 = 16;
					...
					arg5.method476(local81, arg2, anIntArray21[arg3] * local810, local96, arg3 * 512, anIntArray18[arg3], anIntArray20[arg3] * local810, arg8, local832, local110, arg1);
					if (local84.anInt45 != -1) {
						arg6.method453(new LocEntity(true, arg7, arg1, 0, 1, SeqType.aSeqTypeArray1[local84.anInt45], arg2, arg8));
					}
				} else if (arg4 == 6) {
					local132 = local84.method26(4, 0, local36, local47, local60, local71, -1);
					arg5.method476(local81, arg2, 0, local96, arg3, 256, 0, arg8, local132, local110, arg1);
					if (local84.anInt45 != -1) {
						arg6.method453(new LocEntity(true, arg7, arg1, 0, 1, SeqType.aSeqTypeArray1[local84.anInt45], arg2, arg8));
					}
				} else if (arg4 == 7) {
					local132 = local84.method26(4, 0, local36, local47, local60, local71, -1);
					arg5.method476(local81, arg2, 0, local96, arg3, 512, 0, arg8, local132, local110, arg1);
					if (local84.anInt45 != -1) {
						arg6.method453(new LocEntity(true, arg7, arg1, 0, 1, SeqType.aSeqTypeArray1[local84.anInt45], arg2, arg8));
					}
				} else if (arg4 == 8) {
					local132 = local84.method26(4, 0, local36, local47, local60, local71, -1);
					arg5.method476(local81, arg2, 0, local96, arg3, 768, 0, arg8, local132, local110, arg1);
					if (local84.anInt45 != -1) {
						arg6.method453(new LocEntity(true, arg7, arg1, 0, 1, SeqType.aSeqTypeArray1[local84.anInt45], arg2, arg8));
					}
				}
			...
			arg5.method473(local132, arg8, local96, arg2, arg1, local110, local81);
			if (local84.aBoolean7 && local84.aBoolean9 && arg0 != null) {
				arg0.method252(arg2, arg8);
			}
			if (local84.anInt45 != -1) {
				arg6.method453(new LocEntity(true, arg7, arg1, 0, 3, SeqType.aSeqTypeArray1[local84.anInt45], arg2, arg8));
			}
		}
	}

	@OriginalMember(owner = "client!c", name = "a", descriptor = "(Lclient!r;I[Lclient!ec;)V")
	public final void method40(@OriginalArg(0) MapSquare arg0, @OriginalArg(2) CollisionMap[] arg1) {
		@Pc(7) int local7;
		@Pc(11) int local11;
		@Pc(27) int local27;
						...
						if (local284 >= 1 && local284 < this.anInt83 - 1 && (!aBoolean23 || (this.aByteArrayArrayArray1[local7][local169][local284] & 0x10) == 0 && this.method41(local7, local169, local284) == anInt81)) {
							...
							if (local655 > 0 || local666 > 0) {
								...
								if (local666 == 0) {
									...
									@Pc(934) int local934;
									if (local928 >= 0) {
										local934 = Draw3D.method293(local928);
										local936 = -1;
					...
					for (local139 = 0; local139 <= this.anInt82; local139++) {
						if ((this.anIntArrayArrayArray2[local1145][local139][local133] & local27) != 0) {
							...
							if (local204 >= 8) {
								...
								MapSquare.method470(local145 * 128 + 128, local139 * 128, local220, 1, local139 * 128, local1127, local214, local141 * 128);
						...
						if ((this.anIntArrayArrayArray2[local1145][local139][local133] & local1123) != 0) {
							...
							if (local204 >= 8) {
								...
								MapSquare.method470(local133 * 128, local141 * 128, local220, 2, local145 * 128 + 128, local1127, local214, local133 * 128);
								for (local236 = local169; local236 <= local191; local236++) {
									for (local284 = local141; local284 <= local145; local284++) {
						...
						if ((this.anIntArrayArrayArray2[local1145][local139][local133] & local1125) != 0) {
							...
							if ((local145 + 1 - local141) * (local191 - local169 + 1) >= 4) {
								...
								MapSquare.method470(local191 * 128 + 128, local141 * 128, local204, 4, local145 * 128 + 128, local1127, local204, local169 * 128);
