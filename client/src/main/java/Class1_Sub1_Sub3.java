...
public class Class1_Sub1_Sub3 extends Class1_Sub1 {
	...
	private final int anInt881 = 332;
	...
	public final void method569(@OriginalArg(1) boolean arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		if (this.anInt907 != -1 && Static20.aClass19Array1[this.anInt907].anInt545 <= 1) {
			this.anInt907 = -1;
		}
		if (!arg0) {
			@Pc(22) int local22 = arg1 - this.anIntArray232[0];
			@Pc(29) int local29 = arg2 - this.anIntArray233[0];
	...
	public final void method570(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
