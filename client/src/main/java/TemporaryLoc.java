...
public final class TemporaryLoc extends Node {
	...
	public TemporaryLoc(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		this.plane = arg0;
		this.classType = arg8;
		this.x = arg7;
		this.z = arg2;
