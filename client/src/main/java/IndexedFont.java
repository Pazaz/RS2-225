...
public final class IndexedFont extends Draw2D {
	...
	public IndexedFont(@OriginalArg(0) FileArchive arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		@Pc(71) Buffer local71 = new Buffer(363, arg0.method536(arg1 + ".dat", null));
		@Pc(81) Buffer local81 = new Buffer(363, arg0.method536("index.dat", null));
	...
	private void method372(@OriginalArg(0) byte[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (arg6 > 0 && arg2 > 0) {
			this.method373(arg2, local10, arg6, Draw2D.anIntArray178, arg0, arg5, local18, local14, local16, arg3);
		}
	}
