...
public final class TileOverlay {
	...
	private static final int[][] SHAPE_VERTICES = new int[][] { { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 2, 6 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 13, 14 } };

	@OriginalMember(owner = "client!i", name = "y", descriptor = "[[I")
	private static final int[][] SHAPE_PATHS = new int[][] { { 0, 1, 2, 3, 0, 0, 1, 3 }, { 1, 1, 2, 3, 1, 0, 1, 3 }, { 0, 1, 2, 3, 1, 0, 1, 3 }, { 0, 0, 1, 2, 0, 0, 2, 4, 1, 0, 4, 3 }, { 0, 0, 1, 4, 0, 0, 4, 3, 1, 1, 2, 4 }, { 0, 0, 4, 3, 1, 0, 1, 2, 1, 0, 2, 4 }, { 0, 1, 2, 4, 1, 0, 1, 4, 1, 0, 4, 3 }, { 0, 4, 1, 2, 0, 4, 2, 5, 1, 0, 4, 5, 1, 0, 5, 3 }, { 0, 4, 1, 2, 0, 4, 2, 3, 0, 4, 3, 5, 1, 0, 4, 5 }, { 0, 0, 4, 5, 1, 4, 1, 2, 1, 4, 2, 3, 1, 4, 3, 5 }, { 0, 0, 1, 5, 0, 1, 4, 5, 0, 1, 2, 4, 1, 0, 5, 3, 1, 5, 4, 3, 1, 4, 2, 3 }, { 1, 0, 1, 5, 1, 1, 4, 5, 1, 1, 2, 4, 0, 0, 5, 3, 0, 5, 4, 3, 0, 4, 2, 3 }, { 1, 0, 5, 4, 1, 0, 1, 5, 0, 0, 4, 3, 0, 4, 5, 3, 0, 5, 2, 3, 0, 1, 2, 5 } };
	...
	public TileOverlay(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int obfuscator, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18, @OriginalArg(19) int arg19) {
		if (arg17 != arg3 || arg17 != arg13 || arg17 != arg7) {
			this.isFlat = false;
		}
		this.shape = arg1;
		this.orientation = arg5;
		this.underlayRgb = arg12;
		this.overlayRgb = arg8;
		@Pc(32) short local32 = 128;
		@Pc(36) int local36 = local32 / 2;
		@Pc(40) int local40 = local32 / 4;
		@Pc(46) int local46 = local32 * 3 / 4;
		@Pc(50) int[] local50 = SHAPE_VERTICES[arg1];
		...
		if (obfuscator != -1) {
			this.triangleTextureIndex = new int[local143];
		}
		local145 = 0;
		for (local147 = 0; local147 < local143; local147++) {
			...
			this.triangleColorA[local147] = local151;
			this.triangleColorB[local147] = local617;
			this.triangleColorC[local147] = local623;
			if (local149 == 0) {
				this.triangleVertexA[local147] = local68[local151];
				this.triangleVertexB[local147] = local68[local617];
				this.triangleVertexC[local147] = local68[local623];
				if (this.triangleTextureIndex != null) {
					this.triangleTextureIndex[local147] = -1;
				}
			} else {
				this.triangleVertexA[local147] = local71[local151];
				this.triangleVertexB[local147] = local71[local617];
				this.triangleVertexC[local147] = local71[local623];
				if (this.triangleTextureIndex != null) {
					this.triangleTextureIndex[local147] = obfuscator;
				}
			}
		}
		local149 = arg17;
