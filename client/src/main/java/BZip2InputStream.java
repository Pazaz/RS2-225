...
public final class BZip2InputStream {
	...
	private static void finish(@OriginalArg(0) BZip2Context arg0) {
		...
		@Pc(10) int local10 = arg0.nBlockUsed;
	...
	private static void decompress(@OriginalArg(0) BZip2Context arg0) {
		...
		if (BZip2Context.tt == null) {
			BZip2Context.tt = new int[arg0.blockSize100k * 100000];
		}
				...
				while (true) {
					while (local582 != local462) {
						if (local582 == 0 || local582 == 1) {
							...
							while (local592 > 0) {
								BZip2Context.tt[local520] = local64 & 0xFF;
								local520++;
								local592--;
							}
						} else {
							...
							BZip2Context.tt[local520] = arg0.seqToUnseq[local64 & 0xFF] & 0xFF;
							local520++;
							if (local551 == 0) {
								local469++;
								local551 = 50;
					...
					for (local164 = 0; local164 < local520; local164++) {
						local64 = (byte) (BZip2Context.tt[local164] & 0xFF);
						BZip2Context.tt[arg0.cftab[local64 & 0xFF]] |= local164 << 8;
						arg0.cftab[local64 & 0xFF]++;
					}
					arg0.tPos = BZip2Context.tt[arg0.origPtr] >> 8;
					arg0.nBlockUsed = 0;
					arg0.tPos = BZip2Context.tt[arg0.tPos];
					arg0.k0 = (byte) (arg0.tPos & 0xFF);
					arg0.tPos >>= 0x8;
					arg0.nBlockUsed++;
					arg0.count = local520;
					finish(arg0);
					if (arg0.nBlockUsed == arg0.count + 1 && arg0.stateOutLen == 0) {
						local60 = true;
						break;
					}
					local60 = false;
	...
	private static int getBits(@OriginalArg(0) int arg0, @OriginalArg(1) BZip2Context arg1) {
		while (arg1.bsLive < arg0) {
			arg1.bsBuff = arg1.bsBuff << 8 | arg1.stream[arg1.nextIn] & 0xFF;
			arg1.bsLive += 8;
			arg1.nextIn++;
			arg1.availIn--;
			arg1.totalInLo32++;
