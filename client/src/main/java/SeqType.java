...
public final class SeqType {
	...
	public static void method374(@OriginalArg(0) FileArchive arg0) {
		@Pc(9) Buffer local9 = new Buffer(363, arg0.method536("seq.dat", null));
		...
		for (@Pc(27) int local27 = 0; local27 < anInt542; local27++) {
			...
			aSeqTypeArray1[local27].method375(local9);
		}
	}
	...
	private void method375(@OriginalArg(1) Buffer arg0) {
		while (true) {
