...
public final class LocType {
	...
	public static void unpack(@OriginalArg(0) FileArchive arg0) {
		aClass1_Sub3_Sub3_1 = new Buffer(363, arg0.read("loc.dat", null, (byte) 2));
				...
				while (true) {
					...
					if (local15 == 1) {
						...
						for (local33 = 0; local33 < local23; local33++) {
							this.anIntArray4[local33] = arg1.g2();
							this.anIntArray5[local33] = arg1.g1();
						}
					} else if (local15 == 2) {
						this.aString1 = arg1.gstr();
					} else if (local15 == 3) {
						this.aByteArray1 = arg1.gstrbyte((byte) 31);
					} else if (local15 == 14) {
						this.anInt43 = arg1.g1();
					} else if (local15 == 15) {
						this.anInt44 = arg1.g1();
					} else if (local15 == 17) {
						...
						this.anInt46 = arg1.g1();
					} else if (local15 == 29) {
						this.aByte2 = arg1.g1b();
					} else if (local15 == 39) {
						this.aByte3 = arg1.g1b();
					} else if (local15 >= 30 && local15 < 39) {
						if (this.aStringArray1 == null) {
							this.aStringArray1 = new String[5];
						}
						this.aStringArray1[local15 - 30] = arg1.gstr();
						...
						for (local33 = 0; local33 < local23; local33++) {
							this.anIntArray6[local33] = arg1.g2();
							this.anIntArray7[local33] = arg1.g2();
						}
					} else if (local15 == 60) {
						this.anInt47 = arg1.g2();
					} else if (local15 == 62) {
						this.aBoolean14 = true;
					} else if (local15 == 64) {
						this.aBoolean15 = false;
					} else if (local15 == 65) {
						this.anInt49 = arg1.g2();
					} else if (local15 == 66) {
						this.anInt50 = arg1.g2();
					} else if (local15 == 67) {
						this.anInt51 = arg1.g2();
					} else if (local15 == 68) {
						this.anInt48 = arg1.g2();
					} else if (local15 == 69) {
						this.anInt55 = arg1.g1();
					} else if (local15 == 70) {
						this.anInt52 = arg1.g2b();
					} else if (local15 == 71) {
						this.anInt53 = arg1.g2b();
					} else if (local15 == 72) {
						this.anInt54 = arg1.g2b();
					} else if (local15 == 73) {
