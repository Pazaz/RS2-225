...
public final class LocType {
	...
	public static void method21(@OriginalArg(0) FileArchive arg0) {
		aClass1_Sub3_Sub3_1 = new Buffer(363, arg0.method536("loc.dat", null));
		@Pc(21) Buffer local21 = new Buffer(363, arg0.method536("loc.idx", null));
	...
	private void method25(@OriginalArg(1) Buffer arg0) {
		@Pc(12) int local12 = -1;
		while (true) {
			while (true) {
	...
	public final Model method26(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) int local3 = -1;
		...
		@Pc(56) Model local56 = (Model) aCache_2.method527(local47);
		@Pc(91) int local91;
		@Pc(141) int local141;
		if (local56 == null) {
			...
			@Pc(200) Model local200 = (Model) aCache_1.method527((long) local91);
			if (local200 == null) {
				local200 = new Model(false, local91 & 0xFFFF);
				if (local188) {
					local200.method238();
				}
				aCache_1.method528((long) local91, local200);
			}
			...
			aCache_2.method528(local47, local284);
