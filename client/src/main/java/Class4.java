...
public final class Class4 {
				...
				for (@Pc(28) int local28 = 0; local28 < 64; local28++) {
					...
					if (local34 >= 0 && local34 < 104 && local38 >= 0 && local38 < 104) {
						...
						while (true) {
							...
							if (local60 == 0) {
								if (local20 == 0) {
									this.anIntArrayArrayArray1[0][local34][local38] = -Static4.method42(local34 + arg1 + 932731, local38 + 556238 + arg4) * 8;
								} else {
	...
	public final void method38(@OriginalArg(0) byte[] arg0, @OriginalArg(1) Class33 arg1, @OriginalArg(2) Class9[] arg2, @OriginalArg(3) Class28 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(7) Class1_Sub3_Sub3 local7 = new Class1_Sub3_Sub3(363, arg0);
		@Pc(19) int local19 = -1;
		while (true) {
	...
	private void method39(@OriginalArg(0) Class9 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Class33 arg5, @OriginalArg(7) Class28 arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		if (Static4.aBoolean23) {
			...
			if (this.method41(arg1, arg8, arg2) != Static4.anInt81) {
				return;
			}
		}
		...
		@Pc(84) Class2 local84 = Static2.method23(arg7);
		...
		if (arg4 != 22) {
			...
			if (arg4 == 10 || arg4 == 11) {
				...
				if (local84.anInt45 != -1) {
					arg6.method453(new Class1_Sub6(true, arg7, arg1, 0, 2, Static20.aClass19Array1[local84.anInt45], arg2, arg8));
				}
			} else if (arg4 >= 12) {
				...
				arg5.method475(0, local81, arg1, Static4.anIntArray18[arg3], local132, null, arg8, local96, arg2, local110);
				if (arg3 == 0) {
				...
				if (local84.anInt45 != -1) {
					arg6.method453(new Class1_Sub6(true, arg7, arg1, 0, 0, Static20.aClass19Array1[local84.anInt45], arg2, arg8));
				}
				...
				arg5.method475(0, local81, arg1, Static4.anIntArray19[arg3], local132, null, arg8, local96, arg2, local110);
				if (local84.aBoolean15) {
					if (arg3 == 0) {
						this.aByteArrayArrayArray6[arg1][arg8][arg2 + 1] = 50;
					} else if (arg3 == 1) {
				...
				if (arg4 == 2) {
					...
					arg5.method475(Static4.anIntArray18[local810], local81, arg1, Static4.anIntArray18[arg3], local822, local832, arg8, local96, arg2, local110);
					if (local84.aBoolean12) {
						if (arg3 == 0) {
							this.anIntArrayArrayArray2[arg1][arg8][arg2] |= 0x249;
							this.anIntArrayArrayArray2[arg1][arg8][arg2 + 1] |= 0x492;
					...
					arg5.method476(local81, arg2, 0, local96, arg3 * 512, Static4.anIntArray18[arg3], 0, arg8, local132, local110, arg1);
					if (local84.anInt45 != -1) {
						arg6.method453(new Class1_Sub6(true, arg7, arg1, 0, 1, Static20.aClass19Array1[local84.anInt45], arg2, arg8));
					}
				} else if (arg4 == 5) {
					local810 = 16;
					...
					arg5.method476(local81, arg2, Static4.anIntArray21[arg3] * local810, local96, arg3 * 512, Static4.anIntArray18[arg3], Static4.anIntArray20[arg3] * local810, arg8, local832, local110, arg1);
					if (local84.anInt45 != -1) {
						arg6.method453(new Class1_Sub6(true, arg7, arg1, 0, 1, Static20.aClass19Array1[local84.anInt45], arg2, arg8));
					}
				} else if (arg4 == 6) {
			...
			if (local84.anInt45 != -1) {
				arg6.method453(new Class1_Sub6(true, arg7, arg1, 0, 3, Static20.aClass19Array1[local84.anInt45], arg2, arg8));
			}
		}
	}

	@OriginalMember(owner = "client!c", name = "a", descriptor = "(Lclient!r;I[Lclient!ec;)V")
	public final void method40(@OriginalArg(0) Class33 arg0, @OriginalArg(2) Class9[] arg1) {
		@Pc(7) int local7;
		@Pc(11) int local11;
		@Pc(27) int local27;
			...
			for (local169 = -5; local169 < this.anInt82 + 5; local169++) {
				...
				if (local169 >= 1 && local169 < this.anInt82 - 1) {
					...
					for (local284 = -5; local284 < this.anInt83 + 5; local284++) {
						...
						if (local284 >= 1 && local284 < this.anInt83 - 1 && (!Static4.aBoolean23 || (this.aByteArrayArrayArray1[local7][local169][local284] & 0x10) == 0 && this.method41(local7, local169, local284) == Static4.anInt81)) {
							...
							if (local655 > 0 || local666 > 0) {
								...
								if (local666 == 0) {
									...
									@Pc(934) int local934;
									if (local928 >= 0) {
										local934 = Static15.method293(local928);
										local936 = -1;
					...
					for (local139 = 0; local139 <= this.anInt82; local139++) {
						if ((this.anIntArrayArrayArray2[local1145][local139][local133] & local27) != 0) {
							...
							if (local204 >= 8) {
								...
								Static25.method470(local145 * 128 + 128, local139 * 128, local220, 1, local139 * 128, local1127, local214, local141 * 128);
						...
						if ((this.anIntArrayArrayArray2[local1145][local139][local133] & local1123) != 0) {
							...
							if (local204 >= 8) {
								...
								Static25.method470(local133 * 128, local141 * 128, local220, 2, local145 * 128 + 128, local1127, local214, local133 * 128);
								for (local236 = local169; local236 <= local191; local236++) {
									for (local284 = local141; local284 <= local145; local284++) {
						...
						if ((this.anIntArrayArrayArray2[local1145][local139][local133] & local1125) != 0) {
							...
							if ((local145 + 1 - local141) * (local191 - local169 + 1) >= 4) {
								...
								Static25.method470(local191 * 128 + 128, local141 * 128, local204, 4, local145 * 128 + 128, local1127, local204, local169 * 128);
