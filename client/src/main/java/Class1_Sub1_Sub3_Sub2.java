...
public final class Class1_Sub1_Sub3_Sub2 extends Class1_Sub1_Sub3 {
	...
	public final void method572(@OriginalArg(1) Class1_Sub3_Sub3 arg0) {
		arg0.anInt561 = 0;
		...
		this.aString29 = Static30.method542(Static30.method539(arg0.method397()));
	...
	public final Class1_Sub3_Sub1 method568() {
		...
		if (super.anInt912 != -1 && super.anInt913 != -1) {
			...
			local51.method230();
			local51.method231(local35.aClass19_1.anIntArray186[super.anInt913]);
	...
	private Class1_Sub3_Sub1 method573() {
		...
		if (local101 == null) {
			...
			for (@Pc(110) int local110 = 0; local110 < 12; local110++) {
				...
				if (local117 >= 512) {
					...
					@Pc(161) Class1_Sub3_Sub1 local161 = local155.method60(this.anInt930);
					if (local161 != null) {
			...
			Static33.aClass35_9.method528(local4, local101);
		}
		if (this.aBoolean163) {
			return local101;
		}
		...
		if (local6 != -1 && local8 != -1) {
			local249.method232(local8, local6, Static20.aClass19Array1[super.anInt907].anIntArray189);
		} else if (local6 != -1) {
	...
	public final Class1_Sub3_Sub1 method574() {
		if (!this.aBoolean162) {
			return null;
		}
		...
		for (@Pc(13) int local13 = 0; local13 < 12; local13++) {
			...
			if (local20 >= 256 && local20 < 512) {
				local9[local11++] = Static16.aClass13Array1[local20 - 256].method307();
			}
			if (local20 >= 512) {
				@Pc(49) Class1_Sub3_Sub1 local49 = Static5.method54(local20 - 512).method61(this.anInt930);
				if (local49 != null) {
