...
public final class Draw3D extends Draw2D {
	...
	public static IndexedSprite[] aIndexedSpriteArray4;
	...
	static {
		...
		aIndexedSpriteArray4 = new IndexedSprite[50];
	...
	private static int[] getTexels(@OriginalArg(0) int arg0) {
		...
		@Pc(79) IndexedSprite local79 = aIndexedSpriteArray4[arg0];
	...
	public static void setBrightness(@OriginalArg(1) double arg0) {
		...
		for (@Pc(298) int local298 = 0; local298 < 50; local298++) {
			if (aIndexedSpriteArray4[local298] != null) {
	...
	private static void drawGouraudScanline(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		...
		if (aBoolean99) {
			if (aBoolean97) {
				...
				if (arg3 > Draw2D.anInt534) {
					arg3 = Draw2D.anInt534;
				}
				if (arg2 < 0) {
					arg4 -= arg2 * local18;
					arg2 = 0;
