...
public final class SoundTrack {
	...
	public static void load(@OriginalArg(0) Buffer arg0) {
		...
		while (true) {
			...
			A_SOUND_TRACK_ARRAY_1[local16].read(arg0);
			anIntArray231[local16] = A_SOUND_TRACK_ARRAY_1[local16].trim();
		}
	}

	@OriginalMember(owner = "client!yb", name = "a", descriptor = "(BII)Lclient!kb;")
	public static Buffer generate(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		if (A_SOUND_TRACK_ARRAY_1[arg1] == null) {
			return null;
		} else {
			@Pc(12) SoundTrack local12 = A_SOUND_TRACK_ARRAY_1[arg1];
			return local12.toWav(arg0);
		}
	}
	...
	private void read(@OriginalArg(1) Buffer arg0) {
		for (@Pc(1) int local1 = 0; local1 < 10; local1++) {
			@Pc(6) int local6 = arg0.g1();
			if (local6 != 0) {
				arg0.anInt561--;
				this.aSoundToneArray1[local1] = new SoundTone();
				this.aSoundToneArray1[local1].read(arg0);
			}
		}
		this.anInt878 = arg0.g2();
		this.anInt879 = arg0.g2();
	}
	...
	private Buffer toWav(@OriginalArg(1) int arg0) {
		@Pc(3) int local3 = this.generate(arg0);
		aBuffer_23.anInt561 = 0;
		aBuffer_23.p4(1380533830);
		aBuffer_23.p4le(local3 + 36);
		aBuffer_23.p4(1463899717);
		aBuffer_23.p4(1718449184);
		aBuffer_23.p4le(16);
		aBuffer_23.p2le(this.aBoolean158, 1);
		aBuffer_23.p2le(this.aBoolean158, 1);
		aBuffer_23.p4le(22050);
		aBuffer_23.p4le(22050);
		aBuffer_23.p2le(this.aBoolean158, 1);
		aBuffer_23.p2le(this.aBoolean158, 8);
		aBuffer_23.p4(1684108385);
		aBuffer_23.p4le(local3);
	...
	private int generate(@OriginalArg(0) int arg0) {
		...
		for (@Pc(106) int local106 = 0; local106 < 10; local106++) {
			if (this.aSoundToneArray1[local106] != null) {
				...
				@Pc(145) int[] local145 = this.aSoundToneArray1[local106].generate(local123, this.aSoundToneArray1[local106].anInt947);
