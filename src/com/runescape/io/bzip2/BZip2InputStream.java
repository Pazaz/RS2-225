package com.runescape.io.bzip2;
...
public class BZip2InputStream {
    ...
    public static void method334(BZip2Context class35) {
    ...
    public static void method335(BZip2Context class35) {
        boolean flag = false;
        boolean flag1 = false;
        boolean flag2 = false;
        boolean flag3 = false;
        ...
        if (BZip2Context.anIntArray629 == null)
            BZip2Context.anIntArray629 = new int[class35.anInt620 * 0x186a0];
        boolean flag19 = true;
        while (flag19) {
            ...
            for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
                if (k5 == 0 || k5 == 1) {
                    ...
                    BZip2Context.anIntArray629[i6] = class35.aByteArray633[byte6 & 0xff] & 0xff;
                    i6++;
                    if (j5 == 0) {
                        i5++;
                        j5 = 50;
            ...
            for (int l2 = 0; l2 < i6; l2++) {
                ...
                BZip2Context.anIntArray629[class35.anIntArray627[byte7 & 0xff]] |= l2 << 8;
                class35.anIntArray627[byte7 & 0xff]++;
            }

            class35.anInt623 = BZip2Context.anIntArray629[class35.anInt622] >> 8;
            class35.anInt626 = 0;
            class35.anInt623 = BZip2Context.anIntArray629[class35.anInt623];
    ...
    public static byte method336(BZip2Context class35) {
        return (byte) method338(8, class35);
    }

    public static byte method337(BZip2Context class35) {
        return (byte) method338(1, class35);
    }

    public static int method338(int i, BZip2Context class35) {
        int j;
        do {
    ...
    public static void method339(BZip2Context class35) {
        class35.anInt630 = 0;
        for (int i = 0; i < 256; i++)
    ...
    public static BZip2Context aClass35_589 = new BZip2Context();
