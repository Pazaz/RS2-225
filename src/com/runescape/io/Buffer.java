...
import com.runescape.util.IsaacRandom;
...
public class Buffer extends CacheableNode {
    ...
    public static Buffer method433(int i, int j) {
        synchronized (aClass27_1338) {
            ...
            if (i == 0 && anInt1334 > 0) {
                anInt1334--;
                class38_sub2_sub3_2 = (Buffer) aClass27_1337.method269();
            } else if (i == 1 && anInt1335 > 0) {
                anInt1335--;
                class38_sub2_sub3_2 = (Buffer) aClass27_1338.method269();
            } else if (i == 2 && anInt1336 > 0) {
                anInt1336--;
                class38_sub2_sub3_2 = (Buffer) aClass27_1339.method269();
            }
    ...
    public IsaacRandom aClass37_1333;
    public static int anInt1334;
    public static int anInt1335;
    public static int anInt1336;
    public static LinkedList aClass27_1337 = new LinkedList(0);
    public static LinkedList aClass27_1338 = new LinkedList(0);
    public static LinkedList aClass27_1339 = new LinkedList(0);
