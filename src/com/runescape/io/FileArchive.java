...
public class FileArchive {
    ...
    public FileArchive(byte[] abyte0, boolean flag) {
        aBoolean658 = false;
        aByte659 = 2;
        anInt660 = 40267;
        aBoolean661 = false;
    ...
    public void method473(boolean flag, byte[] abyte0) {
        ...
        if (j != i) {
            ...
            BZip2InputStream.method333(abyte1, i, abyte0, j, 6);
            aByteArray662 = abyte1;
            class38_sub2_sub3 = new Buffer(363, aByteArray662);
            aBoolean668 = true;
        } else {
        ...
        for (int k = 0; k < anInt663; k++)
            if (anIntArray664[k] == i) {
                ...
                if (!aBoolean668) {
                    ...
                    BZip2InputStream.method333(abyte0, anIntArray665[k], aByteArray662, anIntArray666[k], anIntArray667[k]);
                } else {
