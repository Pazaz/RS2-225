...
import com.runescape.util.PlayerTracking;
...
public class GameShell extends Applet
    ...
    public void method1(int i, int j, int k) {
        ...
        anInt12 = j;
        anInt13 = i;
        aFrame_Sub1_17 = new GameFrame(anInt13, 35731, this, anInt12);
        aGraphics14 = method11(aByte5).getGraphics();
        aClass31_15 = new DrawArea(method11(aByte5), anInt12, 299, anInt13);
        method12(this, 1);
    }
    ...
    public void mousePressed(MouseEvent mouseevent) {
        ...
        if (PlayerTracking.aBoolean198)
            PlayerTracking.method187(i, mouseevent.isMetaDown() ? 1 : 0, j, (byte) 4);
    }
    ...
    public void mouseReleased(MouseEvent mouseevent) {
        ...
        anInt20 = 0;
        if (PlayerTracking.aBoolean198)
            PlayerTracking.method188(mouseevent.isMetaDown() ? 1 : 0, 0);
    }
    ...
    public void mouseEntered(MouseEvent mouseevent) {
        if (PlayerTracking.aBoolean198)
            PlayerTracking.method194(-657);
    }

    public void mouseExited(MouseEvent mouseevent) {
        if (PlayerTracking.aBoolean198)
            PlayerTracking.method195(false);
    }
    ...
    public void mouseDragged(MouseEvent mouseevent) {
        ...
        anInt22 = j;
        if (PlayerTracking.aBoolean198)
            PlayerTracking.method189(j, true, i);
    }
    ...
    public void keyPressed(KeyEvent keyevent) {
        ...
        if (PlayerTracking.aBoolean198)
            PlayerTracking.method190(j, true);
    }
    ...
    public void focusGained(FocusEvent focusevent) {
        ...
        method10(3);
        if (PlayerTracking.aBoolean198)
            PlayerTracking.method192(-936);
    }

    public void focusLost(FocusEvent focusevent) {
        if (PlayerTracking.aBoolean198)
            PlayerTracking.method193(0);
    }
