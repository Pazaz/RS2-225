...
public class ObjType {
    ...
    public static void method167(FileArchive class39) {
        aClass38_Sub2_Sub3_139 = new Buffer(363, class39.method474("obj.dat", null, (byte) 2));
        Buffer class38_sub2_sub3 = new Buffer(363, class39.method474("obj.idx", null, (byte) 2));
        ...
        aClass4Array140 = new ObjType[10];
        for (int k = 0; k < 10; k++)
            aClass4Array140[k] = new ObjType();
    ...
    public static ObjType method169(int i) {
        ...
        ObjType class4 = aClass4Array140[anInt141];
    ...
    public void method172(int i) {
        ObjType class4 = method169(anInt177);
        ...
        ObjType class4_1 = method169(anInt176);
    ...
    public static Sprite method174(int i, int j, int k) {
        ...
        Draw2D.method376(32, class38_sub2_sub2_sub2.anIntArray1465, -657, 32);
        Draw2D.method380(0, 0, 0, (byte) 93, 32, 32);
        Draw3D.method385(anInt135);
        Model class38_sub2_sub1 = class4.method173(1);
        int j3 = Draw3D.anIntArray1446[class4.anInt150] * class4.anInt149 >> 16;
        int k3 = Draw3D.anIntArray1447[class4.anInt150] * class4.anInt149 >> 16;
        ...
        if (class4.anInt177 != -1) {
            Sprite class38_sub2_sub2_sub2_1 = method174(class4.anInt176, 24638, 10);
        ...
        Draw2D.method376(l1, ai1, -657, i2);
    ...
    public static ObjType[] aClass4Array140;
    ...
    public int anInt176;
    public int anInt177;
    public static Cache aClass34_178 = new Cache((byte) 0, 50);
    public static Cache aClass34_179 = new Cache((byte) 0, 200);
