...
public class VarpType {
    ...
    public static void method227(FileArchive class39, int i) {
        Buffer class38_sub2_sub3 = new Buffer(363, class39.method474("varp.dat", null, (byte) 2));
        anInt421 = 0;
        i = 28 / i;
        anInt419 = class38_sub2_sub3.method448();
        if (aClass22Array420 == null)
            aClass22Array420 = new VarpType[anInt419];
        if (anIntArray422 == null)
            anIntArray422 = new int[anInt419];
        for (int j = 0; j < anInt419; j++) {
            if (aClass22Array420[j] == null)
                aClass22Array420[j] = new VarpType();
    ...
    public static VarpType[] aClass22Array420;
