...
public class LocType {
    ...
    public static void method140(FileArchive class39) {
        aClass38_Sub2_Sub3_38 = new Buffer(363, class39.method474("loc.dat", null, (byte) 2));
        Buffer class38_sub2_sub3 = new Buffer(363, class39.method474("loc.idx", null, (byte) 2));
        ...
        aClass1Array39 = new LocType[10];
        for (int k = 0; k < 10; k++)
            aClass1Array39[k] = new LocType();
    ...
    public static LocType method142(int i) {
        for (int j = 0; j < 10; j++)
            if (aClass1Array39[j].anInt41 == i)
                return aClass1Array39[j];

        anInt40 = (anInt40 + 1) % 10;
        LocType class1 = aClass1Array39[anInt40];
    ...
    public void method144(boolean flag, Buffer class38_sub2_sub3) {
        if (flag) {
            for (int i = 1; i > 0; i++)
                ;
        }
    ...
    public Model method145(int i, int j, int k, int l, int i1, int j1, int k1) {
        int l1 = -1;
        ...
        if (aBoolean35)
            l2 = 0L;
        Model class38_sub2_sub1 = (Model) aClass34_75.method341(l2);
        if (class38_sub2_sub1 != null) {
            if (aBoolean35)
                return class38_sub2_sub1;
            if (aBoolean53 || aBoolean54)
                class38_sub2_sub1 = new Model(class38_sub2_sub1, (byte) -31, aBoolean53, aBoolean54);
            if (aBoolean53) {
                int j2 = (k + l + i1 + j1) / 4;
        ...
        if (flag)
            k2 += 0x10000;
        Model class38_sub2_sub1_1 = (Model) aClass34_74.method341(k2);
        ...
        Model class38_sub2_sub1_2 = new Model(class38_sub2_sub1_1, anIntArray46 == null,
        ...
        if (aBoolean53 || aBoolean54)
            class38_sub2_sub1_2 = new Model(class38_sub2_sub1_2, (byte) -31, aBoolean53, aBoolean54);
        if (aBoolean53) {
            int l4 = (k + l + i1 + j1) / 4;
    ...
    public static Buffer aClass38_Sub2_Sub3_38;
    public static LocType[] aClass1Array39;
    ...
    public static Cache aClass34_74 = new Cache((byte) 0, 500);
    public static Cache aClass34_75 = new Cache((byte) 0, 30);
