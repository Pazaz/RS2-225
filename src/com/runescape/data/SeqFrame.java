...
public class SeqFrame {
    ...
    public static void method213(boolean flag, FileArchive class39) {
        if (flag)
        ...
        aClass11Array235 = new SeqFrame[j + 1];
        int[] ai = new int[500];
        int[] ai1 = new int[500];
        int[] ai2 = new int[500];
        int[] ai3 = new int[500];
        for (int k = 0; k < i; k++) {
            ...
            SeqFrame class11 = aClass11Array235[l] = new SeqFrame();
            class11.anInt236 = class38_sub2_sub3_3.method446();
            int i1 = class38_sub2_sub3.method448();
            SeqBase class9 = SeqBase.aClass9Array216[i1];
    ...
    public static SeqFrame[] aClass11Array235;
    public int anInt236;
    public SeqBase aClass9_237;
    public int anInt238;
