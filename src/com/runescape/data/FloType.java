...
public class FloType {
    ...
    public static void method209(FileArchive class39, int i) {
        Buffer class38_sub2_sub3 = new Buffer(363, class39.method474("flo.dat", null, (byte) 2));
        anInt222 = class38_sub2_sub3.method448();
        i = 35 / i;
        if (aClass10Array223 == null)
            aClass10Array223 = new FloType[anInt222];
        for (int j = 0; j < anInt222; j++) {
            if (aClass10Array223[j] == null)
                aClass10Array223[j] = new FloType();
    ...
    public static FloType[] aClass10Array223;
    public int anInt224;
    public int anInt225;
