...
import com.runescape.graphics.IndexedFont;
import com.runescape.graphics.Sprite;
import com.runescape.io.Buffer;
import com.runescape.io.FileArchive;
import com.runescape.util.Cache;
import com.runescape.util.StringHelper;

public class GameComponent {

    public static void method218(FileArchive class39, IndexedFont[] aclass38_sub2_sub2_sub4, int i,
                                 FileArchive class39_1) {
        i = 17 / i;
        aClass34_321 = new Cache((byte) 0, 50000);
        aClass34_322 = new Cache((byte) 0, 50000);
        Buffer class38_sub2_sub3 = new Buffer(363, class39_1.method474("data", null, (byte) 2));
        int j = -1;
        int k = class38_sub2_sub3.method448();
        aClass14Array264 = new GameComponent[k];
        while (class38_sub2_sub3.anInt1329 < class38_sub2_sub3.aByteArray1328.length) {
            ...
            GameComponent class14 = aClass14Array264[l] = new GameComponent();
            class14.anInt269 = l;
            class14.anInt270 = j;
            ...
            if (class14.anInt271 == 2) {
                ...
                class14.aClass38_Sub2_Sub2_Sub2Array295 = new Sprite[20];
    ...
    public static Sprite method220(FileArchive class39, int i, String s, int j) {
        long l = (StringHelper.method477(0, s) << 8) + (long) i;
        ...
        try {
            class38_sub2_sub2_sub2 = new Sprite(class39, s, i);
    ...
    public static GameComponent[] aClass14Array264;
    ...
    public IndexedFont aClass38_Sub2_Sub2_Sub4_302;
    ...
    public static Cache aClass34_321;
    public static Cache aClass34_322;
}
