...
import com.runescape.scene.VertexNormal;
import com.runescape.util.CacheableNode;
import com.runescape.util.Metadata;
...
public class Model extends CacheableNode {
    ...
    public static void method352(int i, FileArchive class39) {
        if (i < 3 || i > 3)
            return;
        try {
            aClass38_Sub2_Sub3_1260 = new Buffer(363, class39.method474("ob_head.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1261 = new Buffer(363, class39.method474("ob_face1.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1262 = new Buffer(363, class39.method474("ob_face2.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1263 = new Buffer(363, class39.method474("ob_face3.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1264 = new Buffer(363, class39.method474("ob_face4.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1265 = new Buffer(363, class39.method474("ob_face5.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1266 = new Buffer(363, class39.method474("ob_point1.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1267 = new Buffer(363, class39.method474("ob_point2.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1268 = new Buffer(363, class39.method474("ob_point3.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1269 = new Buffer(363, class39.method474("ob_point4.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1270 = new Buffer(363, class39.method474("ob_point5.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1271 = new Buffer(363, class39.method474("ob_vertex1.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1272 = new Buffer(363, class39.method474("ob_vertex2.dat", null, (byte) 2));
            aClass38_Sub2_Sub3_1273 = new Buffer(363, class39.method474("ob_axis.dat", null, (byte) 2));
            ...
            aClass21Array1259 = new Metadata[j + 100];
            int k = 0;
            int l = 0;
            int i1 = 0;
            int j1 = 0;
            ...
            for (int j2 = 0; j2 < j; j2++) {
                ...
                Metadata class21 = aClass21Array1259[k2] = new Metadata();
    ...
    public Model(boolean flag, int i) {
        ...
        if (aClass21Array1259 == null)
            return;
        Metadata class21 = aClass21Array1259[i];
        if (class21 == null) {
    ...
    public Model(Model class38_sub2_sub1, byte byte0, boolean flag, boolean flag1) {
        ...
        if (flag1) {
            ...
            aClass25Array1257 = new VertexNormal[anInt1222];
            for (int i1 = 0; i1 < anInt1222; i1++) {
                VertexNormal class25 = aClass25Array1257[i1] = new VertexNormal();
                VertexNormal class25_1 = class38_sub2_sub1.aClass25Array1257[i1];
    ...
    public void method358(int i, int j) {
        ...
        if (j == -1)
            return;
        SeqFrame class11 = SeqFrame.aClass11Array235[j];
        SeqBase class9 = class11.aClass9_237;
        anInt1292 = 0;
        anInt1293 = 0;
        anInt1294 = 0;
    ...
    public void method359(int i, int j, int k, int[] ai) {
        ...
        SeqFrame class11 = SeqFrame.aClass11Array235[k];
        if (j < 3 || j > 3)
            anInt1220 = -162;
        SeqFrame class11_1 = SeqFrame.aClass11Array235[i];
        SeqBase class9 = class11.aClass9_237;
        anInt1292 = 0;
        anInt1293 = 0;
        anInt1294 = 0;
    ...
    public void method367(int i, int j, int k, int l, int i1, boolean flag) {
        ...
        if (aClass25Array1257 == null) {
            ...
            for (int l1 = 0; l1 < anInt1222; l1++)
                aClass25Array1257[l1] = new VertexNormal();
        ...
        for (int i2 = 0; i2 < anInt1226; i2++) {
            ...
            if (anIntArray1233 == null || (anIntArray1233[i2] & 1) == 0) {
                VertexNormal class25_2 = aClass25Array1257[j2];
        ...
        if (flag) {
            ...
            aClass25Array1258 = new VertexNormal[anInt1222];
            for (int k2 = 0; k2 < anInt1222; k2++) {
                VertexNormal class25 = aClass25Array1257[k2];
                VertexNormal class25_1 = aClass25Array1258[k2] = new VertexNormal();
    ...
    public void method368(int i, int j, int k, int l, int i1) {
        for (int j1 = 0; j1 < anInt1226; j1++) {
            ...
            if (anIntArray1233 == null) {
                ...
                VertexNormal class25 = aClass25Array1257[k1];
                ...
                VertexNormal class25_1 = aClass25Array1257[k1];
    ...
    public VertexNormal[] aClass25Array1257;
    public VertexNormal[] aClass25Array1258;
    public static Metadata[] aClass21Array1259;
    public static Buffer aClass38_Sub2_Sub3_1260;
    public static Buffer aClass38_Sub2_Sub3_1261;
    public static Buffer aClass38_Sub2_Sub3_1262;
    public static Buffer aClass38_Sub2_Sub3_1263;
    public static Buffer aClass38_Sub2_Sub3_1264;
    public static Buffer aClass38_Sub2_Sub3_1265;
    public static Buffer aClass38_Sub2_Sub3_1266;
    public static Buffer aClass38_Sub2_Sub3_1267;
    public static Buffer aClass38_Sub2_Sub3_1268;
    public static Buffer aClass38_Sub2_Sub3_1269;
    public static Buffer aClass38_Sub2_Sub3_1270;
    public static Buffer aClass38_Sub2_Sub3_1271;
    public static Buffer aClass38_Sub2_Sub3_1272;
    public static Buffer aClass38_Sub2_Sub3_1273;
