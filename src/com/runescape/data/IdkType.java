...
public class IdkType {
    ...
    public static void method214(FileArchive class39, int i) {
        Buffer class38_sub2_sub3 = new Buffer(363, class39.method474("idk.dat", null, (byte) 2));
        anInt246 = class38_sub2_sub3.method448();
        if (aClass12Array247 == null)
            aClass12Array247 = new IdkType[anInt246];
        for (int j = 0; j < anInt246; j++) {
            if (aClass12Array247[j] == null)
                aClass12Array247[j] = new IdkType();
    ...
    public static IdkType[] aClass12Array247;
    public int anInt248;
