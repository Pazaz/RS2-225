...
public class SeqType {
    ...
    public static void method222(FileArchive class39, int i) {
        Buffer class38_sub2_sub3 = new Buffer(363, class39.method474("seq.dat", null, (byte) 2));
        if (i <= 0)
            aBoolean361 = !aBoolean361;
        anInt363 = class38_sub2_sub3.method448();
        if (aClass18Array364 == null)
            aClass18Array364 = new SeqType[anInt363];
        for (int j = 0; j < anInt363; j++) {
            if (aClass18Array364[j] == null)
                aClass18Array364[j] = new SeqType();
            ...
            if (j == 1) {
                ...
                for (int k = 0; k < anInt365; k++) {
                    ...
                    if (anIntArray368[k] == 0)
                        anIntArray368[k] = SeqFrame.aClass11Array235[anIntArray366[k]].anInt236;
                    if (anIntArray368[k] == 0)
                        anIntArray368[k] = 1;
                }
    ...
    public static SeqType[] aClass18Array364;
    public int anInt365;
