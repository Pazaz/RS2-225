...
public class NPCType {
    ...
    public static void method146(FileArchive class39) {
        aClass38_Sub2_Sub3_79 = new Buffer(363, class39.method474("npc.dat", null, (byte) 2));
        Buffer class38_sub2_sub3 = new Buffer(363, class39.method474("npc.idx", null, (byte) 2));
        ...
        aClass2Array80 = new NPCType[20];
        for (int k = 0; k < 20; k++)
            aClass2Array80[k] = new NPCType();
    ...
    public static NPCType method148(int i) {
        ...
        NPCType class2 = aClass2Array80[anInt81] = new NPCType();
    ...
    public static NPCType[] aClass2Array80;
    ...
    public int anInt102;
    public int anInt103;
    public static Cache aClass34_104 = new Cache((byte) 0, 30);
