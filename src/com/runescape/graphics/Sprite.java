...
public class Sprite extends Draw2D {
    ...
    public Sprite(FileArchive class39, String s, int i) {
        aBoolean1460 = false;
        aBoolean1462 = false;
        anInt1463 = 15223;
        aByte1464 = 5;
        Buffer class38_sub2_sub3 = new Buffer(363, class39.method474(s + ".dat", null, (byte) 2));
    ...
    public void method401(byte byte0) {
        ...
        Draw2D.method376(anInt1466, anIntArray1465, -657, anInt1467);
    }
    ...
    public void method412(IndexedSprite class38_sub2_sub2_sub3, int i, int j, byte byte0) {
        j += anInt1468;
        i += anInt1469;
        int k = j + i * Draw2D.anInt1309;
        int l = 0;
