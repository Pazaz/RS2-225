...
public class Draw3D extends Draw2D {
    ...
    public static void method389(byte byte0, FileArchive class39) {
        if (byte0 != 2)
            return;
        anInt1449 = 0;
        for (int i = 0; i < 50; i++)
            try {
                aClass38_Sub2_Sub2_Sub3Array1450[i] = new IndexedSprite(class39, String.valueOf(i), 0);
    ...
    public static int[] method392(int i) {
        ...
        IndexedSprite class38_sub2_sub2_sub3 = aClass38_Sub2_Sub2_Sub3Array1450[i];
    ...
    public static IndexedSprite[] aClass38_Sub2_Sub2_Sub3Array1450 = new IndexedSprite[50];
