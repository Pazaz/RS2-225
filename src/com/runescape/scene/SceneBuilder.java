...
public class SceneBuilder {
    ...
    public void method155(CollisionMap collisionMap, boolean flag, int i, int j, int k, int l, Scene scene,
        ...
        if (l == 22) {
            ...
            if (locType.animationIndex != -1)
                linkedList.pushNext(new LocEntity(true, i1, i, 3, SeqType.seqTypes[locType.animationIndex], j, j1));
            return;
        }
        if (l == 10 || l == 11) {
            ...
            if (locType.animationIndex != -1)
                linkedList.pushNext(new LocEntity(true, i1, i, 2, SeqType.seqTypes[locType.animationIndex], j, j1));
            return;
        }
        if (l >= 12) {
        ...
        if (l == 0) {
            ...
            if (locType.animationIndex != -1)
                linkedList.pushNext(new LocEntity(true, i1, i, 0, SeqType.seqTypes[locType.animationIndex], j, j1));
        ...
        if (l == 4) {
            ...
            if (locType.animationIndex != -1)
                linkedList.pushNext(new LocEntity(true, i1, i, 1, SeqType.seqTypes[locType.animationIndex], j, j1));
            return;
        }
        if (l == 5) {
            int j3 = 16;
    ...
    public static void method166(int i, LinkedList linkedList, CollisionMap collisionMap, int j, int k, int[][][] ai, int l, int i1,
        ...
        if (k1 == 22) {
            ...
            if (locType.animationIndex != -1)
                linkedList.pushNext(new LocEntity(true, j1, i1, 3, SeqType.seqTypes[locType.animationIndex], j, i));
            return;
        }
        if (k1 == 10 || k1 == 11) {
            ...
            if (locType.animationIndex != -1)
                linkedList.pushNext(new LocEntity(true, j1, i1, 2, SeqType.seqTypes[locType.animationIndex], j, i));
            return;
        }
        if (k1 >= 12) {
        ...
        if (k1 == 0) {
            ...
            if (locType.animationIndex != -1)
                linkedList.pushNext(new LocEntity(true, j1, i1, 0, SeqType.seqTypes[locType.animationIndex], j, i));
            return;
        }
        if (k1 == 1) {
        ...
        if (k1 == 4) {
            ...
            if (locType.animationIndex != -1)
                linkedList.pushNext(new LocEntity(true, j1, i1, 1, SeqType.seqTypes[locType.animationIndex], j, i));
            return;
        }
        if (k1 == 5) {
            int l3 = 16;
