...
import com.runescape.data.FloType;
import com.runescape.data.LocType;
...
public class SceneBuilder {
    ...
    public void method152(int i, int j, int k, int l, int i1) {
        ...
        for (int j1 = 0; j1 < FloType.anInt222; j1++) {
            if (!FloType.aClass10Array223[j1].aString228.equalsIgnoreCase("water"))
                continue;
            byte0 = (byte) (j1 + 1);
            break;
        }
    ...
    public void method154(byte[] abyte0, Scene class32, CollisionMap[] aclass8, LinkedList class27, boolean flag, int i,
                          int j) {
        label0:
        {
            Buffer class38_sub2_sub3 = new Buffer(363, abyte0);
    ...
    public void method155(CollisionMap class8, boolean flag, int i, int j, int k, int l, Scene class32,
                          LinkedList class27, int i1, int j1) {
        if (!flag)
            return;
        if (aBoolean108) {
        ...
        if (l == 22) {
            if (aBoolean108 && !class1.aBoolean52 && !class1.aBoolean73)
                return;
            Model class38_sub2_sub1 = class1.method145(22, k, k1, l1, i2, j2, -1);
            ...
            if (class1.anInt56 != -1)
                class27.method267(new LocEntity(true, i1, i, 0, 3, SeqType.aClass18Array364[class1.anInt56], j, j1));
            return;
        }
        if (l == 10 || l == 11) {
            Model class38_sub2_sub1_1 = class1.method145(10, k, k1, l1, i2, j2, -1);
            ...
            if (class1.anInt56 != -1)
                class27.method267(new LocEntity(true, i1, i, 0, 2, SeqType.aClass18Array364[class1.anInt56], j, j1));
            return;
        }
        if (l >= 12) {
            Model class38_sub2_sub1_2 = class1.method145(l, k, k1, l1, i2, j2, -1);
        ...
        if (l == 0) {
            Model class38_sub2_sub1_3 = class1.method145(0, k, k1, l1, i2, j2, -1);
            ...
            if (class1.anInt56 != -1)
                class27.method267(new LocEntity(true, i1, i, 0, 0, SeqType.aClass18Array364[class1.anInt56], j, j1));
            if (class1.anInt57 != 16)
                class32.method298(i, j, j1, class1.anInt57, (byte) 6);
            return;
        }
        if (l == 1) {
            Model class38_sub2_sub1_4 = class1.method145(1, k, k1, l1, i2, j2, -1);
        ...
        if (l == 2) {
            int i3 = k + 1 & 3;
            Model class38_sub2_sub1_11 = class1.method145(2, 4 + k, k1, l1, i2, j2, -1);
            Model class38_sub2_sub1_12 = class1.method145(2, i3, k1, l1, i2, j2, -1);
        ...
        if (l == 3) {
            Model class38_sub2_sub1_5 = class1.method145(3, k, k1, l1, i2, j2, -1);
        ...
        if (l == 9) {
            Model class38_sub2_sub1_6 = class1.method145(l, k, k1, l1, i2, j2, -1);
        ...
        if (l == 4) {
            Model class38_sub2_sub1_7 = class1.method145(4, 0, k1, l1, i2, j2, -1);
            class32.method290(k2, j, 0, l2, k * 512, anIntArray127[k], 465, 0, j1, class38_sub2_sub1_7, byte0, i);
            if (class1.anInt56 != -1)
                class27.method267(new LocEntity(true, i1, i, 0, 1, SeqType.aClass18Array364[class1.anInt56], j, j1));
            return;
        }
        if (l == 5) {
            int j3 = 16;
            ...
            if (l3 > 0)
                j3 = LocType.method142(l3 >> 14 & 0x7fff).anInt57;
            Model class38_sub2_sub1_13 = class1.method145(4, 0, k1, l1, i2, j2, -1);
        ...
        if (l == 6) {
            Model class38_sub2_sub1_8 = class1.method145(4, 0, k1, l1, i2, j2, -1);
        ...
        if (l == 7) {
            Model class38_sub2_sub1_9 = class1.method145(4, 0, k1, l1, i2, j2, -1);
        ...
        if (l == 8) {
            Model class38_sub2_sub1_10 = class1.method145(4, 0, k1, l1, i2, j2, -1);
    ...
    public void method156(Scene class32, int i, CollisionMap[] aclass8) {
        for (int j = 0; j < 4; j++) {
            for (int k = 0; k < 104; k++) {
            ...
            for (int i7 = -5; i7 < anInt111 + 5; i7++) {
                for (int j8 = 0; j8 < anInt112; j8++) {
                    ...
                    if (l9 >= 0 && l9 < anInt111) {
                        ...
                        if (i13 > 0) {
                            FloType class10 = FloType.aClass10Array223[i13 - 1];
                    ...
                    if (j13 >= 0 && j13 < anInt111) {
                        ...
                        if (j14 > 0) {
                            FloType class10_1 = FloType.aClass10Array223[j14 - 1];
                        ...
                        if (l17 >= 1 && l17 < anInt112 - 1
                            ...
                            if (i19 > 0 || j19 > 0) {
                                ...
                                if (l > 0) {
                                    ...
                                    if (j19 > 0 && !FloType.aClass10Array223[j19 - 1].aBoolean227)
                                        flag = false;
                                ...
                                if (j19 == 0) {
                                    ...
                                    FloType class10_2 = FloType.aClass10Array223[j19 - 1];
                                    ...
                                    if (j23 >= 0) {
                                        ...
                                        l23 = Draw3D.anIntArray1458[method164(class10_2.anInt234, 96)];
                                    }
    ...
    public static void method166(int i, LinkedList class27, CollisionMap class8, int j, int k, int[][][] ai, int l,
                                 int i1,
                                 int j1, int k1, Scene class32, int l1) {
        if (l != 0)
        ...
        LocType class1 = LocType.method142(j1);
        int j3 = i + (j << 7) + (j1 << 14) + 0x40000000;
        if (!class1.aBoolean52)
            j3 += 0x80000000;
        byte byte0 = (byte) ((k << 6) + k1);
        if (k1 == 22) {
            Model class38_sub2_sub1 = class1.method145(22, k, i2, j2, k2, l2, -1);
            ...
            if (class1.anInt56 != -1)
                class27.method267(new LocEntity(true, j1, i1, 0, 3, SeqType.aClass18Array364[class1.anInt56], j, i));
            return;
        }
        if (k1 == 10 || k1 == 11) {
            Model class38_sub2_sub1_1 = class1.method145(10, k, i2, j2, k2, l2, -1);
            if (class38_sub2_sub1_1 != null) {
                int l4 = 0;
                if (k1 == 11)
                    l4 += 256;
            ...
            if (class1.anInt56 != -1)
                class27.method267(new LocEntity(true, j1, i1, 0, 2, SeqType.aClass18Array364[class1.anInt56], j, i));
            return;
        }
        if (k1 >= 12) {
            Model class38_sub2_sub1_2 = class1.method145(k1, k, i2, j2, k2, l2, -1);
        ...
        if (k1 == 0) {
            Model class38_sub2_sub1_3 = class1.method145(0, k, i2, j2, k2, l2, -1);
            ...
            if (class1.anInt56 != -1)
                class27.method267(new LocEntity(true, j1, i1, 0, 0, SeqType.aClass18Array364[class1.anInt56], j, i));
            return;
        }
        if (k1 == 1) {
            Model class38_sub2_sub1_4 = class1.method145(1, k, i2, j2, k2, l2, -1);
        ...
        if (k1 == 2) {
            int k3 = k + 1 & 3;
            Model class38_sub2_sub1_11 = class1.method145(2, 4 + k, i2, j2, k2, l2, -1);
            Model class38_sub2_sub1_12 = class1.method145(2, k3, i2, j2, k2, l2, -1);
        ...
        if (k1 == 3) {
            Model class38_sub2_sub1_5 = class1.method145(3, k, i2, j2, k2, l2, -1);
        ...
        if (k1 == 9) {
            Model class38_sub2_sub1_6 = class1.method145(k1, k, i2, j2, k2, l2, -1);
        ...
        if (k1 == 4) {
            Model class38_sub2_sub1_7 = class1.method145(4, 0, i2, j2, k2, l2, -1);
            class32.method290(i3, j, 0, j3, k * 512, anIntArray127[k], 465, 0, i, class38_sub2_sub1_7, byte0, i1);
            if (class1.anInt56 != -1)
                class27.method267(new LocEntity(true, j1, i1, 0, 1, SeqType.aClass18Array364[class1.anInt56], j, i));
            return;
        }
        if (k1 == 5) {
            int l3 = 16;
            ...
            if (j4 > 0)
                l3 = LocType.method142(j4 >> 14 & 0x7fff).anInt57;
            Model class38_sub2_sub1_13 = class1.method145(4, 0, i2, j2, k2, l2, -1);
        ...
        if (k1 == 6) {
            Model class38_sub2_sub1_8 = class1.method145(4, 0, i2, j2, k2, l2, -1);
        ...
        if (k1 == 7) {
            Model class38_sub2_sub1_9 = class1.method145(4, 0, i2, j2, k2, l2, -1);
        ...
        if (k1 == 8) {
            Model class38_sub2_sub1_10 = class1.method145(4, 0, i2, j2, k2, l2, -1);
