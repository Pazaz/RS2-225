...
public class PlayerEntity extends PathingEntity {
    ...
    public void method470(boolean flag, Buffer class38_sub2_sub3) {
        ...
        if (super.anInt1391 == 65535)
            super.anInt1391 = -1;
        aString1505 = StringHelper.method479(0, StringHelper.method476(class38_sub2_sub3.method452(603), false));
    ...
    public Model method462(boolean flag) {
        ...
        if (super.anInt1412 != -1 && super.anInt1413 != -1) {
            ...
            Model class38_sub2_sub1_2 = new Model(class20.method226(), true,
    ...
    public Model method471(boolean flag) {
        ...
        if (super.anInt1407 >= 0 && super.anInt1410 == 0) {
            SeqType class18 = SeqType.aClass18Array364[super.anInt1407];
            ...
            i = SeqType.aClass18Array364[super.anInt1404].anIntArray366[super.anInt1405];
        ...
        if (class38_sub2_sub1 == null) {
            ...
            for (int k1 = 0; k1 < 12; k1++) {
                ...
                if (k >= 0 && k1 == 5)
                    l1 = k;
                if (l1 >= 256 && l1 < 512)
                    aclass38_sub2_sub1[j1++] = IdkType.aClass12Array247[l1 - 256].method216();
                if (l1 >= 512) {
                    ObjType class4 = ObjType.method169(l1 - 512);
                    Model class38_sub2_sub1_2 = class4.method175((byte) 6, anInt1507);
        ...
        if (i != -1 && j != -1)
            class38_sub2_sub1_1.method359(j, 3, i, SeqType.aClass18Array364[super.anInt1407].anIntArray370);
        else if (i != -1)
    ...
    public Model method472(int i) {
        ...
        for (int k = 0; k < 12; k++) {
            ...
            if (l >= 256 && l < 512)
                aclass38_sub2_sub1[j++] = IdkType.aClass12Array247[l - 256].method217(false);
            if (l >= 512) {
    ...
    public static Cache aClass34_1525 = new Cache((byte) 0, 200);
