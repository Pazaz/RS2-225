...
public class SoundTrack {
    ...
    public static void method487(Buffer class38_sub2_sub3, int i) {
        aByteArray693 = new byte[0x6baa8];
        aClass38_Sub2_Sub3_694 = new Buffer(363, aByteArray693);
        i = 87 / i;
        SoundTone.method493();
        do {
    ...
    public void method489(boolean flag, Buffer class38_sub2_sub3) {
        for (int i = 0; i < 10; i++) {
            int j = class38_sub2_sub3.method446();
            if (j != 0) {
                class38_sub2_sub3.anInt1329--;
                aClass44Array695[i] = new SoundTone();
    ...
    public Buffer method491(boolean flag, int i) {
        int j = method492(i);
    ...
    public SoundTrack() {
        aBoolean689 = true;
        aClass44Array695 = new SoundTone[10];
    }

    public boolean aBoolean689;
    public static int anInt690 = 473;
    public static SoundTrack[] aClass43Array691 = new SoundTrack[1000];
    public static int[] anIntArray692 = new int[1000];
    public static byte[] aByteArray693;
    public static Buffer aClass38_Sub2_Sub3_694;
    public SoundTone[] aClass44Array695;
    public int anInt696;
    public int anInt697;
