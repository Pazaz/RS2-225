...
public class Game extends GameShell {
            ...
            if (obj != null && ((PathingEntity) (obj)).isValid(false)) {
                ...
                if (((PathingEntity) (obj)).spoken != null && (j >= anInt823 || anInt976 == 0 || anInt976 == 3
                    ...
                    if (anInt1019 > -1 && anInt1091 < anInt1092) {
                        anIntArray1096[anInt1091] = indexedFont3.stringWidth(
                                ((PathingEntity) (obj)).spoken) / 2;
                        anIntArray1095[anInt1091] = indexedFont3.height;
        ...
        for (int k = 0; k < anInt1091; k++) {
            ...
            if (anInt800 == 0) {
                ...
                if (anIntArray1098[k] == 0) {
                    indexedFont3.drawRightAligned(anInt1020 + 1, 0, s, anInt1019);
                    indexedFont3.drawRightAligned(anInt1020, l2, s, anInt1019);
                }
                if (anIntArray1098[k] == 1) {
                    indexedFont3.drawCenteredWave(anInt837, anInt1019, anInt1020 + 1, 0, s);
                    indexedFont3.drawCenteredWave(anInt837, anInt1019, anInt1020, l2, s);
                }
                if (anIntArray1098[k] == 2) {
                    int l3 = indexedFont3.stringWidth(s);
                    int i4 = ((150 - anIntArray1099[k]) * (l3 + 100)) / 150;
                    Draw2D.setBounds(334, 0, anInt1019 + 50, anInt1019 - 50);
                    indexedFont3.draw((anInt1019 + 50) - i4, anInt1020 + 1, 0, s);
                    indexedFont3.draw((anInt1019 + 50) - i4, anInt1020, l2, s);
                    Draw2D.resetBounds();
                }
            } else {
                indexedFont3.drawRightAligned(anInt1020 + 1, 0, s, anInt1019);
                indexedFont3.drawRightAligned(anInt1020, 0xffff00, s, anInt1019);
            }
        }
    ...
    public void method18(int i) {
        int j = (localPlayerEntity.x >> 7) + anInt761;
        int k = (localPlayerEntity.z >> 7) + anInt762;
        if (i != 39734)
    ...
    public void method19(int i) {
        ...
        for (int k = 0; k < 100; k++)
            if (aStringArray898[k] != null) {
                ...
                if (l == 5 && anInt755 < 2) {
                    int j1 = 329 - j * 13;
                    indexedFont.draw(4, j1, 0, aStringArray898[k]);
                    indexedFont.draw(4, j1 - 1, 65535, aStringArray898[k]);
                    if (++j >= 5)
                        return;
                }
                if (l == 6 && anInt755 < 2) {
        ...
        for (int k = 0; k < anInt825; k++) {
            ...
            if ((i1 & 2) == 2) {
                ...
                if (j1 == -1 || npcEntity.primarySeq == -1
                        || SeqType.animations[j1].priority > SeqType.animations[npcEntity.primarySeq].priority
                        || SeqType.animations[npcEntity.primarySeq].priority == 0) {
            ...
            if ((i1 & 8) == 8) {
                npcEntity.spoken = class38_sub2_sub3.readString();
                npcEntity.textCycle = 100;
            }
            if ((i1 & 0x10) == 16) {
                npcEntity.anInt1396 = class38_sub2_sub3.readByte();
                npcEntity.anInt1397 = class38_sub2_sub3.readByte();
                npcEntity.cycleStatus = clientClock + 400;
            ...
            if ((i1 & 0x20) == 32) {
                ...
                npcEntity.runSeq = npcEntity.info.walkSeq;
                npcEntity.walkSeq = npcEntity.info.turnAroundSeq;
                npcEntity.turnAroundSeq = npcEntity.info.turnRightSeq;
                npcEntity.turnRightSeq = npcEntity.info.turnLeftSeq;
            ...
            if ((i1 & 0x40) == 64) {
                ...
                npcEntity.anInt1415 = clientClock + (k1 & 0xffff);
                npcEntity.spotAnimFrame = 0;
                npcEntity.anInt1414 = 0;
                if (npcEntity.anInt1415 > clientClock)
    ...
    public void method22(byte byte0, Buffer class38_sub2_sub3, int i) {
        ...
        if (i == 69) {
            ...
            if (k3 >= 0 && l5 >= 0 && k3 < 104 && l5 < 104 && i8 >= 0 && i10 >= 0 && i8 < 104 && i10 < 104) {
                ...
                i8 = i8 * 128 + 64;
                i10 = i10 * 128 + 64;
                ProjectileEntity projectileEntity = new ProjectileEntity(i15, i17, l5, j16 + clientClock, anInt880, l11,
                        k15 + clientClock, k17, method33(anInt880, k3, (byte) 5, l5) - k14, k13, k3);
                projectileEntity.setTarget(method33(anInt880, i8, (byte) 5, i10) - i15, i10, i8, k15 + clientClock);
        ...
        if (i == 23) {
            ...
            if (playerEntity != null) {
                TemporaryLoc temporaryLoc = new TemporaryLoc(anInt880, k12, k6, j15 + clientClock, l10, -1, j4, l13);
                linkedList3.pushNext(temporaryLoc);
                TemporaryLoc temporaryLoc_1 = new TemporaryLoc(anInt880, k12, k6, l15 + clientClock, l10, l14, j4, l13);
                ...
                playerEntity.locSceneY = method33(anInt880, playerEntity.locSceneX, (byte) 5,
    ...
    public int method23(byte byte0) {
        ...
        if (anInt1114 < 310) {
            int j = anInt1111 >> 7;
            int k = anInt1113 >> 7;
            int l = localPlayerEntity.x >> 7;
            int i1 = localPlayerEntity.z >> 7;
        ...
        if ((aByteArrayArrayArray840[anInt880][localPlayerEntity.x >> 7][localPlayerEntity.z >> 7]
                & 4) != 0)
            i = anInt880;
        return i;
    }
    ...
    public void method25(int i) {
        ...
        if (!aBoolean968) {
            ...
            method39(
                    method33(anInt880, localPlayerEntity.x, (byte) 5,
                            localPlayerEntity.z) - 50,
    ...
    public void method31(int i, int j, int k) {
        ...
        for (int i1 = 0; i1 < 100; i1++) {
            ...
            if ((j1 == 1 || j1 == 2)
                ...
                if (i > k1 - 14 && i <= k1 && !aStringArray897[i1].equals(localPlayerEntity.name)) {
                    if (aBoolean1023) {
    ...
    public void method32(int i) {
        if (localPlayerEntity.x >> 7 == anInt1051
                && localPlayerEntity.z >> 7 == anInt1052)
            anInt1051 = 0;
        for (int j = -1; j < anInt823; j++) {
            ...
            if (playerEntity == null || !playerEntity.isValid(false))
                continue;
            playerEntity.lowMemory = (aBoolean889 && anInt823 > 50 || anInt823 > 200) && j != -1
    ...
    public void method34(NpcType npcType, int i, int j, int k, int l) {
        ...
        if (npcType.level != 0)
            s = s + method72(localPlayerEntity.level, false, npcType.level) + " (level-"
                    + npcType.level + ")";
        if (anInt1002 == 1) {
            ...
            if (npcType.options != null) {
                for (int j1 = 4; j1 >= 0; j1--)
                    if (npcType.options[j1] != null && npcType.options[j1].equalsIgnoreCase("attack")) {
                        char c = '\0';
                        if (npcType.level > localPlayerEntity.level)
                            c = '\u07D0';
            ...
            if (anInt971 != -1 && anInt971 == anInt907) {
                ...
                if ((j == 13 || j == 10) && aString1137.length() > 0) {
                    if (aString1137.equals("::clientdrop")
                        ...
                        localPlayerEntity.spoken = aString1137;
                        localPlayerEntity.anInt1394 = j1;
                        localPlayerEntity.anInt1395 = k1;
                        localPlayerEntity.textCycle = 150;
                        method111(2, localPlayerEntity.spoken, (byte) 4,
                                localPlayerEntity.name);
                        if (anInt976 == 2) {
                            anInt976 = 3;
                            aBoolean921 = true;
                            aClass38_Sub2_Sub3_798.writeOpcode(244);
    ...
    public void method43(byte byte0) {
        ...
        for (int j3 = 0; j3 < anInt917; j3++) {
            ...
            int i2 = (anIntArray919[j3] * 4 + 2) - localPlayerEntity.z / 32;
        ...
        for (int k3 = 0; k3 < 104; k3++) {
            for (int l3 = 0; l3 < 104; l3++) {
                ...
                if (linkedList != null) {
                    int l = (k3 * 4 + 2) - localPlayerEntity.x / 32;
                    int j2 = (l3 * 4 + 2) - localPlayerEntity.z / 32;
        ...
        for (int i4 = 0; i4 < anInt928; i4++) {
            ...
            if (npcEntity != null && npcEntity.isValid(false)
                ...
                int i1 = npcEntity.x / 32
                        - localPlayerEntity.x / 32;
                int k2 = npcEntity.z / 32
                        - localPlayerEntity.z / 32;
        ...
        if (anInt1051 != 0) {
            int k1 = (anInt1051 * 4 + 2) - localPlayerEntity.x / 32;
    ...
    public void method47(Buffer class38_sub2_sub3, int i, boolean flag) {
        ...
        for (int j = 0; j < anInt939; j++) {
            ...
            if (npcEntities[k].anInt1424 != clientClock) {
    ...
    public void method49(int i, Buffer class38_sub2_sub3, int j) {
        ...
        for (int j1 = 0; j1 < k; j1++) {
            ...
            if (l1 == 0) {
                ...
                playerEntity.anInt1424 = clientClock;
            } else {
                ...
                if (i2 == 0) {
                    ...
                    playerEntity.walk(true, k2);
                    int i3 = class38_sub2_sub3.getBits(3);
                    playerEntity.walk(true, i3);
    ...
    public void method53(boolean flag) {
        for (int i = 0; i < anInt928; i++) {
            ...
            scene.add(npcEntity.z,
                    ...
                    method33(anInt880, npcEntity.x, (byte) 5,
                            npcEntity.z),
                    anInt880);
        }
    ...
    public void method55(int i) {
        ...
        if (anInt1109 == 0) {
            int j = c1 / 2 - 20;
            indexedFont3.drawCentered(c / 2, 0xffff00, true, j, "Welcome to RuneScape");
            j += 30;
            int i1 = c / 2 - 80;
            int l1 = c1 / 2 + 20;
        ...
        if (anInt1109 == 2) {
            ...
            if (aString1083.length() > 0) {
                indexedFont3.drawCentered(c / 2, 0xffff00, true, k - 15, aString1083);
                indexedFont3.drawCentered(c / 2, 0xffff00, true, k, aString1084);
                k += 30;
            } else {
                indexedFont3.drawCentered(c / 2, 0xffff00, true, k - 7, aString1084);
                k += 30;
            }
            indexedFont3.draw(c / 2 - 90, k,
                    "Username: " + aString1066 + ((anInt972 == 0) & (clientClock % 40 < 20) ? "@yel@|" : ""), true,
                    0xffffff);
            k += 15;
            indexedFont3.draw(c / 2 - 88, k, "Password: " + StringUtils.toAsterisks(aString1067)
        ...
        if (anInt1109 == 3) {
            indexedFont3.drawCentered(c / 2, 0xffff00, true, c1 / 2 - 60, "Create a free account");
            int l = c1 / 2 - 35;
            indexedFont3.drawCentered(c / 2, 0xffffff, true, l, "To create a new account you need to");
            l += 15;
            indexedFont3.drawCentered(c / 2, 0xffffff, true, l, "go back to the main RuneScape webpage");
            l += 15;
            indexedFont3.drawCentered(c / 2, 0xffffff, true, l, "and choose the red 'create account'");
            l += 15;
            indexedFont3.drawCentered(c / 2, 0xffffff, true, l, "button at the top right of that page.");
            l += 15;
            int k1 = c / 2;
            int j2 = c1 / 2 + 50;
    ...
    public void method57(int i, int j, Buffer class38_sub2_sub3) {
        ...
        do {
            ...
            if (playerEntities[l] == null) {
                playerEntities[l] = new PlayerEntity();
                if (aClass38_Sub2_Sub3Array827[l] != null)
                    playerEntities[l].read(aClass38_Sub2_Sub3Array827[l]);
            }
            ...
            playerEntity.move(k1 == 1,
                    localPlayerEntity.pathTileX[0] + i1,
                    localPlayerEntity.pathTileZ[0] + j1);
            int l1 = class38_sub2_sub3.getBits(1);
            if (l1 == 1)
    ...
    public void method63(PathingEntity pathingEntity, byte byte0, int i) {
        ...
        if (pathingEntity.anInt1421 > clientClock)
            method64(pathingEntity, -25115);
        else if (pathingEntity.anInt1422 >= clientClock)
    ...
    public void method64(PathingEntity pathingEntity, int i) {
        int j = pathingEntity.anInt1421 - clientClock;
        int k = pathingEntity.anInt1417 * 128 + pathingEntity.index * 64;
        int l = pathingEntity.anInt1419 * 128 + pathingEntity.index * 64;
    ...
    public void method65(PathingEntity pathingEntity, int i) {
        anInt779 += i;
        if (pathingEntity.anInt1422 == clientClock || pathingEntity.primarySeq == -1
            ...
            int k = clientClock - pathingEntity.anInt1421;
            int l = pathingEntity.anInt1417 * 128 + pathingEntity.index * 64;
            int i1 = pathingEntity.anInt1419 * 128 + pathingEntity.index * 64;
            int j1 = pathingEntity.anInt1418 * 128 + pathingEntity.index * 64;
            int k1 = pathingEntity.anInt1420 * 128 + pathingEntity.index * 64;
    ...
    public void method66(int i, PathingEntity pathingEntity) {
        ...
        int l1 = 4;
        if (pathingEntity.animationDelay != pathingEntity.dstYaw && pathingEntity.anInt1401 == -1)
            l1 = 2;
    ...
    public void method67(PathingEntity pathingEntity, byte byte0) {
        ...
        if ((pathingEntity.anInt1402 != 0 || pathingEntity.anInt1403 != 0)
            ...
            int j = pathingEntity.x - (pathingEntity.anInt1402 - anInt761 - anInt761) * 64;
            int i1 = pathingEntity.z - (pathingEntity.anInt1403 - anInt762 - anInt762) * 64;
            if (j != 0 || i1 != 0)
    ...
    public void method68(boolean flag, PathingEntity pathingEntity) {
        ...
        if (pathingEntity.spotAnimIndex != -1 && clientClock >= pathingEntity.anInt1415) {
    ...
    public void method71(int i, int j) {
        ...
        if (i1 == 217) {
            boolean flag = method107(localPlayerEntity.pathTileX[0], 0, false, k,
                    localPlayerEntity.pathTileZ[0], 0, 2, 0, l, 0, 0, 0);
            if (!flag)
                flag = method107(localPlayerEntity.pathTileX[0], 1, false, k,
                        localPlayerEntity.pathTileZ[0], 0, 2, 1, l, 0, 0, 0);
            anInt738 = super.anInt24;
            anInt739 = super.anInt25;
            anInt741 = 2;
            anInt740 = 0;
        ...
        if (i1 == 224 || i1 == 993 || i1 == 99 || i1 == 746 || i1 == 877) {
            boolean flag1 = method107(localPlayerEntity.pathTileX[0], 0, false,
                    k, localPlayerEntity.pathTileZ[0], 0, 2, 0, l, 0, 0, 0);
            if (!flag1)
                flag1 = method107(localPlayerEntity.pathTileX[0], 1, false, k,
                        localPlayerEntity.pathTileZ[0], 0, 2, 1, l, 0, 0, 0);
            anInt738 = super.anInt24;
            anInt739 = super.anInt25;
            anInt741 = 2;
        ...
        if (i1 == 965) {
            boolean flag2 = method107(localPlayerEntity.pathTileX[0], 0, false,
                    k, localPlayerEntity.pathTileZ[0], 0, 2, 0, l, 0, 0, 0);
            if (!flag2)
                flag2 = method107(localPlayerEntity.pathTileX[0], 1, false, k,
                        localPlayerEntity.pathTileZ[0], 0, 2, 1, l, 0, 0, 0);
            anInt738 = super.anInt24;
            anInt739 = super.anInt25;
            anInt741 = 2;
    ...
    public void method74(int i) {
        ...
        indexedFont3.draw(j + 3, k + 14, j1, "Choose Option");
        ...
        for (int i2 = 0; i2 < anInt1074; i2++) {
            ...
            if (k1 > j && k1 < j + l && l1 > j2 - 13 && l1 < j2 + 3)
                k2 = 0xffff00;
            indexedFont3.draw(j + 3, j2, aStringArray834[i2], true, k2);
        }
                ...
                for (int j1 = 0; j1 < 5; j1++)
                    if (anIntArray742[j1] != 0) {
                        class38_sub2_sub1.recolor(APPEARANCE_COLORS[j1][0],
                                APPEARANCE_COLORS[j1][anIntArray742[j1]]);
                        if (j1 == 1)
                            class38_sub2_sub1.recolor(BEARD_COLORS[0], BEARD_COLORS[anIntArray742[j1]]);
                    }
    ...
    public void method80(boolean flag, Buffer class38_sub2_sub3, int i) {
        ...
        do {
            ...
            npcEntity.anInt1424 = clientClock;
            npcEntity.info = NpcType.get(class38_sub2_sub3.getBits(11));
            npcEntity.index = npcEntity.info.size;
            npcEntity.runSeq = npcEntity.info.walkSeq;
            npcEntity.walkSeq = npcEntity.info.turnAroundSeq;
            npcEntity.turnAroundSeq = npcEntity.info.turnRightSeq;
            npcEntity.turnRightSeq = npcEntity.info.turnLeftSeq;
            ...
            if (l > 15)
                l -= 32;
            npcEntity.move(false,
                    localPlayerEntity.pathTileX[0] + k,
                    localPlayerEntity.pathTileZ[0] + l);
    ...
    public void method85(int i) {
        int j = localPlayerEntity.x + anInt1125;
        int k = localPlayerEntity.z + anInt1130;
    ...
    public void method86(byte byte0) {
        ...
        for (ProjectileEntity projectileEntity = (ProjectileEntity) linkedList4
                ...
                .getPrevious())
            if (projectileEntity.level != anInt880 || clientClock > projectileEntity.lastCycle)
    ...
    public boolean method92(int i, int j, int k, int l, boolean flag) {
        ...
        if (k1 == 10 || k1 == 11 || k1 == 22) {
            ...
            method107(localPlayerEntity.pathTileX[0], i2, false, j,
                    localPlayerEntity.pathTileZ[0], 0, 2, j2, k, 0, 0, k2);
        } else {
            method107(localPlayerEntity.pathTileX[0], 0, false, j,
                    localPlayerEntity.pathTileZ[0], 0, 2, 0, k, l1, k1 + 1, 0);
        }
        anInt738 = super.anInt24;
        anInt739 = super.anInt25;
        anInt741 = 2;
    ...
    public void method93(int i) {
        int j = indexedFont3.stringWidth("Choose Option");
        for (int k = 0; k < anInt1074; k++) {
            int l = indexedFont3.stringWidth(aStringArray834[k]);
            if (l > j)
                j = l;
        }
    ...
    public void method100(long l, int i) {
        ...
        if (s.equals(localPlayerEntity.name))
            return;
    ...
    public void method102(boolean flag, int i, int j, PlayerEntity playerEntity, int k) {
        if (flag)
        ...
        if (anInt1074 >= 400)
            return;
        String s = playerEntity.name
                + method72(localPlayerEntity.level, false, playerEntity.level) + " (level-"
                + playerEntity.level + ")";
        if (anInt1002 == 1) {
            ...
            if (anInt1101 > 0) {
                ...
                if (localPlayerEntity.level >= playerEntity.level)
    ...
    public void method104(boolean flag) {
        ...
        indexedFont3.drawTooltip(clientClock / 1000, true, 15, 0xffffff, s, 4);
        if (!flag)
            anInt780 = -1;
    }
    ...
    public void method109(Buffer class38_sub2_sub3, int i, int j) {
        ...
        for (int k = 0; k < anInt939; k++) {
            ...
            if (playerEntities[l].anInt1424 != clientClock)
    ...
    public void method115(byte byte0) {
        ...
        if (super.anInt23 == 1) {
            ...
            if (i >= 0 && j >= 0 && i < 146 && j < 151) {
                ...
                int j1 = j * l + i * i1 >> 11;
                int k1 = j * i1 - i * l >> 11;
                int l1 = localPlayerEntity.x + j1 >> 7;
                int i2 = localPlayerEntity.z - k1 >> 7;
                boolean flag = method107(localPlayerEntity.pathTileX[0], 0, true,
                        l1, localPlayerEntity.pathTileZ[0], 0, 1, 0, i2, 0, 0,
                        0);
                if (flag) {
                    ...
                    aClass38_Sub2_Sub3_798.writeByte(anInt930);
                    aClass38_Sub2_Sub3_798.writeByte(89);
                    aClass38_Sub2_Sub3_798.writeWord(localPlayerEntity.x);
                    aClass38_Sub2_Sub3_798.writeWord(localPlayerEntity.z);
        ...
        for (int i1 = 0; i1 < k; i1++) {
            ...
            if (k1 == 0) {
                ...
                if (l1 == 0) {
                    ...
                    npcEntity.anInt1424 = clientClock;
                    int j2 = class38_sub2_sub3.getBits(3);
                    npcEntity.walk(true, j2);
                    int l2 = class38_sub2_sub3.getBits(3);
                    npcEntity.walk(true, l2);
                ...
                if (j1 == 0) {
                    ...
                    if ((playerEntity.x & 0x7f) == 64
                        ...
                        for (int k2 = 0; k2 < anInt823; k2++) {
                            PlayerEntity playerEntity_1 = playerEntities[anIntArray824[k2]];
                            if (playerEntity_1 != null && playerEntity_1 != playerEntity
                                    && playerEntity_1.x == playerEntity.x
                                    && playerEntity_1.z == playerEntity.z)
                                method102(false, i1, anIntArray824[k2], playerEntity_1, l);
                        }

                    }
                    method102(false, i1, k1, playerEntity, l);
                }
                if (j1 == 3) {
    ...
    public void method134(int i, int j, Buffer class38_sub2_sub3) {
        ...
        if (l == 1) {
            ...
            localPlayerEntity.walk(false, i1);
            int l1 = class38_sub2_sub3.getBits(1);
            if (l1 == 1)
                anIntArray826[anInt825++] = anInt821;
            return;
        ...
        if (l == 2) {
            ...
            localPlayerEntity.walk(true, j1);
            int i2 = class38_sub2_sub3.getBits(3);
            localPlayerEntity.walk(true, i2);
            int k2 = class38_sub2_sub3.getBits(1);
            if (k2 == 1)
                anIntArray826[anInt825++] = anInt821;
            return;
        ...
        if (l == 3) {
            ...
            int l2 = class38_sub2_sub3.getBits(1);
            localPlayerEntity.move(l2 == 1, k1, j2);
            int i3 = class38_sub2_sub3.getBits(1);
            if (i3 == 1)
                anIntArray826[anInt825++] = anInt821;
        }
    ...
    public void method135(boolean flag) {
        ...
        if (aBoolean869) {
            ...
            indexedFont3.drawRightAligned(40, 0, "Enter amount:", 239);
            indexedFont3.drawRightAligned(60, 128, aString784 + "*", 239);
        } else if (aString936 != null) {
            indexedFont3.drawRightAligned(40, 0, aString936, 239);
            indexedFont3.drawRightAligned(60, 128, "Click to continue", 239);
        } else if (anInt1001 != -1)
            ...
            for (int j = 0; j < 100; j++)
                if (aStringArray898[j] != null) {
                    ...
                    if (k == 0) {
                        if (l > 0 && l < 110)
                            indexedFont.draw(4, l, 0, aStringArray898[j]);
                        i++;
                    }
                    if (k == 1) {
                        if (l > 0 && l < 110) {
                    ...
                    if (k == 5 && anInt833 == 0 && anInt755 < 2) {
                        if (l > 0 && l < 110)
                            indexedFont.draw(4, l, 0x800000, aStringArray898[j]);
                        i++;
                    }
    ...
    public boolean method136(boolean flag) {
        ...
        try {
            ...
            if (anInt780 == 197) {
                ...
                InterfaceComponent.interfaceComponentArray[j1].aClass38_Sub2_Sub1_310 = localPlayerEntity.getHeadModel();
                anInt780 = -1;
                return true;
            }
            if (anInt780 == 25) {
            ...
            if (anInt780 == 204) {
                ...
                InterfaceComponent.interfaceComponentArray[i4].aClass38_Sub2_Sub1_310 = npcType.getHeadModel();
                anInt780 = -1;
                return true;
            }
            if (anInt780 == 7) {
            ...
            String s2 = "T2 - " + anInt780 + "," + anInt829 + "," + anInt830 + " - " + anInt779 + ","
                    + (anInt761 + localPlayerEntity.pathTileX[0]) + ","
                    + (anInt762 + localPlayerEntity.pathTileZ[0]) + " - ";
    ...
    public boolean method138(int i, String s) {
        ...
        return s.equalsIgnoreCase(localPlayerEntity.name);
    }
    ...
    public void method139(boolean flag, int i, int j, Buffer class38_sub2_sub3,
        ...
        if ((j & 1) == 1) {
            ...
            playerEntity.read(class38_sub2_sub3_1);
        }
        if ((j & 2) == 2) {
            ...
            if (l == -1 || playerEntity.primarySeq == -1
                    || SeqType.animations[l].priority > SeqType.animations[playerEntity.primarySeq].priority
                    || SeqType.animations[playerEntity.primarySeq].priority == 0) {
        ...
        if ((j & 8) == 8) {
            playerEntity.spoken = class38_sub2_sub3.readString();
            playerEntity.anInt1394 = 0;
            playerEntity.anInt1395 = 0;
            playerEntity.textCycle = 150;
            method111(2, playerEntity.spoken, (byte) 4,
                    playerEntity.name);
        }
        if ((j & 0x10) == 16) {
            playerEntity.anInt1396 = class38_sub2_sub3.readByte();
            playerEntity.anInt1397 = class38_sub2_sub3.readByte();
            playerEntity.cycleStatus = clientClock + 400;
        ...
        if ((j & 0x40) == 64) {
            ...
            if (playerEntity.name != null) {
                long l2 = StringUtils.toBase37(playerEntity.name);
                boolean flag1 = false;
                if (l1 <= 1) {
                ...
                if (!flag1 && anInt802 == 0)
                    try {
                        ...
                        playerEntity.spoken = s;
                        playerEntity.anInt1394 = i1 >> 8;
                        playerEntity.anInt1395 = i1 & 0xff;
                        playerEntity.textCycle = 150;
                        if (l1 > 1)
                            method111(1, s, (byte) 4, playerEntity.name);
                        else
                            method111(2, s, (byte) 4, playerEntity.name);
                    } catch (Exception exception) {
        ...
        if ((j & 0x100) == 256) {
            ...
            playerEntity.anInt1415 = clientClock + (j1 & 0xffff);
            playerEntity.spotAnimFrame = 0;
            playerEntity.anInt1414 = 0;
            if (playerEntity.anInt1415 > clientClock)
        ...
        if ((j & 0x200) == 512) {
            ...
            playerEntity.anInt1421 = class38_sub2_sub3.readWord() + clientClock;
            playerEntity.anInt1422 = class38_sub2_sub3.readWord() + clientClock;
            playerEntity.anInt1423 = class38_sub2_sub3.readByte();
            playerEntity.pathRemaining = 0;
            playerEntity.pathTileX[0] = playerEntity.anInt1418;
            playerEntity.pathTileZ[0] = playerEntity.anInt1420;
        }
    }
    ...
    public void method13(boolean flag, String s, int i) {
        ...
        char c1 = '\310';
        byte byte0 = 20;
        indexedFont3.drawRightAligned(c1 / 2 - 26 - byte0, 0xffffff,
        ...
        indexedFont3.drawRightAligned((c1 / 2 + 5) - byte0, 0xffffff, s, c / 2);
        drawArea13.drawImage(186, super.aGraphics14, 214);
        if (aBoolean751) {
            aBoolean751 = false;
            if (!aBoolean902) {
